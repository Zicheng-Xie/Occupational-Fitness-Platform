...
- hearing: `HEAR-COM-UNCONDITIONAL-001` - Unaided hearing loss in the better ear is at or above the commercial unconditional threshold.

## Information coverage

- hypertension: Source-supported facts available; some facts require confirmation; 1 supported fields; 2 unresolved rule fields.
- vision: No source-supported facts for this requested module; 0 supported fields; 6 unresolved rule fields.
- hearing: Source-supported facts available; 4 supported fields; 2 unresolved rule fields.
...
Confirm cardiovascular.blood_pressure.observed_diastolic (unsupported): Independent source reading differs from the extraction. The patient's blood pressure is mentioned as 158/94 mmHg, but this is a single seated observation and no clinician has documented a persistent current pressure.
Fields withheld from rule inputs: cardiovascular.blood_pressure.observed_diastolic

### cardiovascular.blood_pressure.observed_diastolic — unsupported

Independent source reading differs from the extraction. The patient's blood pressure is mentioned as 158/94 mmHg, but this is a single seated observation and no clinician has documented a persistent current pressure.

Source lines 7–7; characters 923:937
> BP 158/94 mmHg
...
Rule-result SHA-256: `f3066d0963d595da53392759f8d49fdc86b4ec01ee65d00c3cab5c1b5eaf1791`
Evidence-pack SHA-256: `19900717ee4421f7c942d452cc51bc16a99ab7ef385b9b7288b0b0b2bf8d8a4b`
