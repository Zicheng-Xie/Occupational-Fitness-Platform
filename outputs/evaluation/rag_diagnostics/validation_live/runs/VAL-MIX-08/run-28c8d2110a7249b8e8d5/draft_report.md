...
VAL-MIX-08: Insufficient information. 5 requested modules; 23 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
Confirm hearing.audiometry.available (unsupported): Independent source reading differs from the extraction. Audiometry has not been performed, but the driver brings an audiology appointment confirmation.
Fields withheld from rule inputs: hearing.audiometry.available

### hearing.audiometry.available — unsupported

Independent source reading differs from the extraction. Audiometry has not been performed, but the driver brings an audiology appointment confirmation.

Source lines 5–5; characters 486:924
...
- `hearing.audiometry.available` = UNKNOWN (requires_confirmation)
  ...
  - Source lines 5–5; chars 486:924: Clinical assessment suggests possible hearing impairment after the driver repeatedly missed spoken instructions, and audiometry has not been performed. He can follow conversation better when facing the speaker, but neither an unaided better-ear threshold nor an aided standard is documented. His employer's earlier form marked hearing satisfactory without describing a test; that form does not supply the missing audiometric measurements.
...
Rule-result SHA-256: `9f20b1788edee17a871c91613bba746c9a71f8dc5a0d51cdb0701974274d9aaa`
Evidence-pack SHA-256: `d7522f8992599054fe582a9cf15d600b6f61a5d44805db5fa0589ad99969be33`
