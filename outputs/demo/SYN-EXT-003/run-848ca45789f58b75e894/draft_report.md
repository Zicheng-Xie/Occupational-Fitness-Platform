# Clinical review draft — SYN-EXT-003

SYN-EXT-003: Temporarily unfit. 5 requested modules; 3 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
- `blackout.mechanism_status` = under_investigation (present)
  - Source lines 16–16; chars 618:667: blackout.mechanism_status = "under_investigation"
- `blackout.occurred` = True (present)
  - Source lines 14–14; chars 566:590: blackout.occurred = true
  - Source lines 14–14; chars 566:590: blackout.occurred = true
...
- `cardiovascular.blood_pressure.persistent_diastolic` = 80.0 (present)
  - Source lines 7–7; chars 272:327: cardiovascular.blood_pressure.persistent_diastolic = 80
  - Source lines 7–7; chars 272:327: cardiovascular.blood_pressure.persistent_diastolic = 80
- `cardiovascular.blood_pressure.persistent_systolic` = 120.0 (present)
  - Source lines 6–6; chars 215:270: cardiovascular.blood_pressure.persistent_systolic = 120
  - Source lines 6–6; chars 215:270: cardiovascular.blood_pressure.persistent_systolic = 120
...
- `vision.diplopia.present` = False (present)
  - Source lines 11–11; chars 458:489: vision.diplopia.present = false
  - Source lines 11–11; chars 458:489: vision.diplopia.present = false
- `vision.monocular` = False (present)
  - Source lines 12–12; chars 491:515: vision.monocular = false
- `vision.uncorrected.better_eye` = 6/6 (present)
  - Source lines 8–8; chars 329:369: vision.uncorrected.right.snellen = "6/6"
  - Source lines 9–9; chars 371:410: vision.uncorrected.left.snellen = "6/6"
...
- `vision.visual_field.confirmed_defect` = False (present)
  - Source lines 10–10; chars 412:456: vision.visual_field.confirmed_defect = false
  - Source lines 10–10; chars 412:456: vision.visual_field.confirmed_defect = false
...
- `hearing.clinical_assessment` = no_hearing_loss (present)
  - Source lines 13–13; chars 517:564: hearing.clinical_assessment = "no_hearing_loss"
  - Source lines 13–13; chars 517:564: hearing.clinical_assessment = "no_hearing_loss"
...
- `diabetes.present` = False (present)
  - Source lines 15–15; chars 592:616: diabetes.present = false
  - Source lines 15–15; chars 592:616: diabetes.present = false
...
blackout.mechanism_status = "under_investigation"

```

Input SHA-256: `0a9b798c0f0b38dd79bf3059287038e4736069145b52c687d11b3875417d17ca`
Rule-result SHA-256: `73296970498080e6b57af7be1f5cab56bda4c234c7f264a12807afd56db8e8a8`
Evidence-pack SHA-256: `afb2e89ef8157db4dfb3f76d45f04680cd919f0bacaf6e623b816013aa9a6881`

## Unverified local-model commentary

This synthetic validation fixture presents a commercial driver assessment with a reported blackout still under investigation. The patient meets unconditional standards for hypertension, vision, and hearing, but is temporarily unfit for driving due to the blackout. A clinician must review the case note and evidence to determine the patient's fitness to drive.
