# Clinical review draft — SYN-M2-007

SYN-M2-007: Insufficient information. 5 requested modules; 9 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
| vision | Insufficient information | missing_information | 3 |
...
- `vision.uncorrected.better_eye` = 6/12 (present)
  - Source lines 1–1; chars 116:171: Unaided visual acuity: right eye 6/24 and left eye 6/12
  - Source lines 1–1; chars 116:171: Unaided visual acuity: right eye 6/24 and left eye 6/12
- `vision.uncorrected.left.snellen` = 6/12 (present)
  - Source lines 1–1; chars 116:171: Unaided visual acuity: right eye 6/24 and left eye 6/12
- `vision.uncorrected.right.snellen` = 6/24 (present)
  - Source lines 1–1; chars 116:171: Unaided visual acuity: right eye 6/24 and left eye 6/12
...
- `hearing.clinical_assessment` = no_hearing_loss (present)
  - Source lines 1–1; chars 208:233: Hearing: WNL without aids
...
```text
Commercial driver medical. 42-year-old male heavy vehicle operator. BP 124/80 mmHg; HR 66 bpm. No cardiac symptoms. Unaided visual acuity: right eye 6/24 and left eye 6/12. No diplopia; visual fields normal. Hearing: WNL without aids.

```

Input SHA-256: `ac36b83ccfc6d4b4b8226e768b2ac21cea698a9423385e5e2263362d31c090f3`
Rule-result SHA-256: `a33a24deee838aa990b04fa5bcea242cb794f5d60bd37b7f67b245a25896887d`
Evidence-pack SHA-256: `9bb8cae5d496fdf115b46c6cce1d0380e54a39d9ef6b9038359a50ad4a55a4f5`

## Unverified local-model commentary

This commercial driver medical assessment is incomplete due to insufficient information in several modules, including hypertension, vision, and blackout. The patient's unaided visual acuity is 6/24 in the right eye and 6/12 in the left eye, and their hearing is within normal limits without aids. The patient's blood pressure is 124/80 mmHg, and they have no cardiac symptoms. Further information is needed to determine the patient's fitness to hold an unconditional or conditional licence.
