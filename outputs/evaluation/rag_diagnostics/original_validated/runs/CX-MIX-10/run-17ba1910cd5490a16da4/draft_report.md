...
Confirm blackout.mechanism_status (uncertainty): Independent source reading differs from the extraction. The driver's description of the event is uncertain, and the nurse has no contemporaneous clinical record confirming hypoglycaemia, a seizure or another cause.
Confirm blackout.occurred (omission): Independent source reading differs from the extraction. The driver describes a short period of unresponsiveness after a delayed lunch.
Confirm diabetes.present (omission): Independent source reading differs from the extraction. The driver uses insulin.
Confirm vision.diplopia.present (omission): Independent source reading differs from the extraction. The driver mentions occasional blurred vision when his glucose changes.
Fields withheld from rule inputs: blackout.mechanism_status, blackout.occurred, diabetes.present, vision.diplopia.present

### blackout.mechanism_status — uncertainty

Independent source reading differs from the extraction. The driver's description of the event is uncertain, and the nurse has no contemporaneous clinical record confirming hypoglycaemia, a seizure or another cause.
...
Independent source reading differs from the extraction. The driver describes a short period of unresponsiveness after a delayed lunch.
...
Independent source reading differs from the extraction. The driver uses insulin.
...
Independent source reading differs from the extraction. The driver mentions occasional blurred vision when his glucose changes.
...
Rule-result SHA-256: `82ed1981863b6d536f2049adabbacab29e3fc0f12cd9baad15e82be89f085275`
Evidence-pack SHA-256: `8cc56e989e84503ffbfaf96f7ea9d8fef774b4dd667eec7683787f6d7d0de8ae`
