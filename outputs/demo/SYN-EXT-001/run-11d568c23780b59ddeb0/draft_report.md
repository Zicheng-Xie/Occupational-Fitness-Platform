# Clinical review draft — SYN-EXT-001

SYN-EXT-001: Meets unconditional standard. 5 requested modules; 0 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
- `cardiovascular.blood_pressure.persistent_diastolic` = 80 (present)
  - Source lines 7–7; chars 280:335: cardiovascular.blood_pressure.persistent_diastolic = 80
- `cardiovascular.blood_pressure.persistent_systolic` = 120 (present)
  - Source lines 6–6; chars 223:278: cardiovascular.blood_pressure.persistent_systolic = 120
...
- `vision.diplopia.present` = False (present)
  - Source lines 11–11; chars 466:497: vision.diplopia.present = false
- `vision.monocular` = False (present)
  - Source lines 12–12; chars 499:523: vision.monocular = false
- `vision.uncorrected.better_eye` = 6/6 (present)
  - Source lines 8–8; chars 337:377: vision.uncorrected.right.snellen = "6/6"
  - Source lines 9–9; chars 379:418: vision.uncorrected.left.snellen = "6/6"
...
- `vision.visual_field.confirmed_defect` = False (present)
  - Source lines 10–10; chars 420:464: vision.visual_field.confirmed_defect = false
...
- `hearing.clinical_assessment` = no_hearing_loss (present)
  - Source lines 13–13; chars 525:572: hearing.clinical_assessment = "no_hearing_loss"
...
- `blackout.occurred` = False (present)
  - Source lines 14–14; chars 574:599: blackout.occurred = false
...
- `diabetes.present` = False (present)
  - Source lines 15–15; chars 601:625: diabetes.present = false
...
Complete normal screening across all five pilot modules.
...
Input SHA-256: `9d0055421fc77ab21be3e935413c7754b71b461f3523cfb9997ce6f8152b9975`
Rule-result SHA-256: `9ce7729fd51e99d0a793ae38840e0fe65e3d8ef022e0fa6c9475c4531cb0dd0b`
Evidence-pack SHA-256: `19f21a11fc29961fe7992ad2c1a9ed6edcf31121d193ade7e6724c71ead1db00`
