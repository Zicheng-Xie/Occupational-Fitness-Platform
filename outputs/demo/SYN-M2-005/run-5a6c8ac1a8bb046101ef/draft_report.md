# Clinical review draft — SYN-M2-005

SYN-M2-005: Insufficient information. 5 requested modules; 12 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
- `hearing.clinical_assessment` = no_hearing_loss (present)
  - Source lines 1–1; chars 293:326: Hearing: WNL without hearing aids
...
```text
Commercial driver medical. 55-year-old female bus driver. Previous myocardial infarction in 2021 with PCI and coronary stent. No specialist report is available for this assessment. BP 134/84 mmHg; pulse 68 bpm. Denies chest pain, palpitations or shortness of breath. Vision: WNL with glasses. Hearing: WNL without hearing aids.

```

Input SHA-256: `7dfe6527a7562797da79c080888c1aab44e1c64021094ddce21c78fcca4c8eb4`
Rule-result SHA-256: `0358af1fdeadccbb5310eac5616f9e128a4bc410753e9edd3807e1ef47df48d3`
Evidence-pack SHA-256: `57459f776e407efe2a329518f9a290cf8244ef50164390a88dc97d8d781e1cdf`

## Unverified local-model commentary

This 55-year-old female bus driver has a history of myocardial infarction in 2021 with PCI and coronary stent. Her blood pressure is 134/84 mmHg, which is within the normal range. She denies chest pain, palpitations, or shortness of breath. Her vision and hearing are normal with and without correction. However, there is insufficient information to assess her hypertension, vision, and blackout modules. A specialist report is not available for this assessment. As such, it is not possible to determine her fitness to hold an unconditional licence at this time. A clinician must review the case to determine the next steps.
