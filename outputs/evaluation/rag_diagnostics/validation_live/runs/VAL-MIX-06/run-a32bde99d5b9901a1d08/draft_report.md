...
VAL-MIX-06: Insufficient information. 5 requested modules; 21 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
| blackout | Insufficient information | human_review | 4 |
| diabetes | Insufficient information | human_review | 2 |

## Retrieval activity

Rule-scoped ranking calls: 31.
...
Confirm blackout.mechanism_status (unsupported): Independent source reading differs from the extraction. The mechanism of the blackout is under investigation, but no diagnosis has been made.
Confirm diabetes.present (uncertainty): Independent source reading differs from the extraction. There is no information about the driver's diabetes status.
Confirm vision.diplopia.present (omission): Independent source reading differs from the extraction. The driver has a visual field defect.
Confirm vision.uncorrected.better_eye (omission): Independent source reading differs from the extraction. The driver's better eye has a Snellen acuity of 20/20.
Confirm vision.uncorrected.left.snellen (uncertainty): Independent source reading differs from the extraction. Better-eye acuity may be calculated only when both eyes have explicit comparable measurements.
Confirm vision.uncorrected.right.snellen (uncertainty): Independent source reading differs from the extraction. Better-eye acuity may be calculated only when both eyes have explicit comparable measurements.
Fields withheld from rule inputs: blackout.mechanism_status, diabetes.present, vision.diplopia.present, vision.uncorrected.better_eye, vision.uncorrected.left.snellen, vision.uncorrected.right.snellen

### blackout.mechanism_status — unsupported

Independent source reading differs from the extraction. The mechanism of the blackout is under investigation, but no diagnosis has been made.
...
Independent source reading differs from the extraction. There is no information about the driver's diabetes status.
...
Independent source reading differs from the extraction. The driver has a visual field defect.
...
### vision.uncorrected.better_eye — omission

Independent source reading differs from the extraction. The driver's better eye has a Snellen acuity of 20/20.
...
Rule-result SHA-256: `b3f59f9e29609d3cbdd54f1398345676dfd786f87480dbdd188cb13b2c3154b0`
Evidence-pack SHA-256: `c3e848a4e9a1fb096e2dd3594e5df37b7ea0d2f9a198b6b655deff1fb392d8c9`
