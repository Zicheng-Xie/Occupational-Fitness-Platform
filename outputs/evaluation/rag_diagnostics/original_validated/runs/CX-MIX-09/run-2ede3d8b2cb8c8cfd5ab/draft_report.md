...
Confirm cardiovascular.blood_pressure.persistent_diastolic (uncertainty): Independent source reading differs from the extraction. No information provided about persistent diastolic blood pressure.
Confirm cardiovascular.blood_pressure.persistent_systolic (uncertainty): Independent source reading differs from the extraction. No information provided about persistent systolic blood pressure.
Confirm vision.diplopia.present (omission): Independent source reading differs from the extraction. The driver denies constant double vision.
Confirm vision.visual_field.confirmed_defect (uncertainty): Independent source reading differs from the extraction. The field printout shows a binocular horizontal extent of 135 degrees, but carries a poor-fixation warning and does not clearly document the vertical test extent, central defects or whether the result is stable over time.
Fields withheld from rule inputs: cardiovascular.blood_pressure.persistent_diastolic, cardiovascular.blood_pressure.persistent_systolic, vision.diplopia.present, vision.visual_field.confirmed_defect

### cardiovascular.blood_pressure.persistent_diastolic — uncertainty

Independent source reading differs from the extraction. No information provided about persistent diastolic blood pressure.
...
Independent source reading differs from the extraction. No information provided about persistent systolic blood pressure.
...
Independent source reading differs from the extraction. The driver denies constant double vision.
...
Independent source reading differs from the extraction. The field printout shows a binocular horizontal extent of 135 degrees, but carries a poor-fixation warning and does not clearly document the vertical test extent, central defects or whether the result is stable over time.

Source lines 5–5; characters 580:943
...
- `vision.visual_field.confirmed_defect` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 580:943: He recalls being told that an old injury left one eye less useful, while an earlier letter records vision in both eyes and no current specialist opinion confirms monocularity. A handwritten acuity entry of 6/9 is not assigned to an eye or labelled as corrected, and the driver alternates between an older pair of glasses and a recently purchased pair during work.
...
Rule-result SHA-256: `643090b7e4a83053a2f623d4128ae99e1e76f0569456781eee570bbc0c38571c`
Evidence-pack SHA-256: `319bb013858bca93d21bd356039a8c8e0d4ee7c673c4fd10a4077f57ce845575`
