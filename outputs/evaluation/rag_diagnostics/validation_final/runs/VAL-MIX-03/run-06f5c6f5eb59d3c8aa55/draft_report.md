...
Confirm hearing.audiometry.available (uncertainty): Independent source reading differs from the extraction. Glucose was measured only after the symptoms settled, so the nurse has no verified measurement during that event.
Confirm hearing.clinical_assessment (uncertainty): Independent source reading differs from the extraction. No complete audiogram accompanies the referral.
...
Independent source reading differs from the extraction. Glucose was measured only after the symptoms settled, so the nurse has no verified measurement during that event.

Source lines 5–5; characters 435:836
> After a delayed lunch last month he felt shaky and ate a snack without assistance, but glucose was measured only after the symptoms settled, so the nurse has no verified measurement during that event and no treating-clinician classification of severe hypoglycaemia. He has brought four weeks of glucose entries rather than a complete three-month record, and the specialist review has not yet occurred.

### hearing.clinical_assessment — uncertainty

Independent source reading differs from the extraction. No complete audiogram accompanies the referral.
...
- `hearing.audiometry.available` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 435:836: After a delayed lunch last month he felt shaky and ate a snack without assistance, but glucose was measured only after the symptoms settled, so the nurse has no verified measurement during that event and no treating-clinician classification of severe hypoglycaemia. He has brought four weeks of glucose entries rather than a complete three-month record, and the specialist review has not yet occurred.
...
Rule-result SHA-256: `c57eac674c1efafc6b86c83b4155de861f5cb5513e8053bc9d10ac4e8207f678`
Evidence-pack SHA-256: `3c17a50b898ee9bc2378710affac9dd0b64b74626f4bda1387c82bcb694db9ae`
