# Clinical review draft — VAL-MIX-07

VAL-MIX-07: Temporarily unfit. 5 requested modules; 21 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.

**DRAFT · pending_clinical_review · Clinical sign-off pending**

| Module | Provisional outcome | Route | Missing fields |
|---|---|---|---|
| hypertension | Insufficient information | human_review | 5 |
...
| diabetes | Temporarily unfit | human_review | 5 |
...
> The patient has confirmed type 2 diabetes and is acutely unwell at the current assessment. The treating physician's signed note explicitly documents metabolically unstable diabetes after reviewing current observations and laboratory results; this is a documented clinical assessment rather than a diagnosis inferred by the nurse from thirst alone. The driver cannot provide a reliable account of the latest diabetes medication change or a complete glucose log, and the visual symptoms have not received an independent specialist assessment. Those missing details remain unresolved even though current metabolic instability and persistent blood pressure are explicitly documented by the treating clinicians.
...
> The GP's separate current summary records that persistent blood pressure remains 182/108 mmHg after repeated measurements. Those missing details remain unresolved even though current metabolic instability and persistent blood pressure are explicitly documented by the treating clinicians.
...
> The patient describes nausea and fluctuating blur, and the planned work assessment has been interrupted for clinical care. The driver cannot provide a reliable account of the latest diabetes medication change or a complete glucose log, and the visual symptoms have not received an independent specialist assessment.
...
Confirm cardiovascular.blood_pressure.observed_diastolic (omission): Independent source reading differs from the extraction. The GP's separate current summary records that persistent blood pressure remains 182/108 mmHg after repeated measurements.
Confirm cardiovascular.blood_pressure.observed_systolic (omission): Independent source reading differs from the extraction. The GP's separate current summary records that persistent blood pressure remains 182/108 mmHg after repeated measurements.
Confirm diabetes.treatment_category (omission): Independent source reading differs from the extraction. The treating physician's signed note explicitly documents metabolically unstable diabetes after reviewing current observations and laboratory results; this is a documented clinical assessment rather than a diagnosis inferred by the nurse from thirst alone.
Confirm vision.diplopia.present (uncertainty): Independent source reading differs from the extraction. The patient describes fluctuating blur, but a visual FIELD defect has not been confirmed.
Confirm vision.visual_field.confirmed_defect (omission): Independent source reading differs from the extraction. The GP's separate current summary records that persistent blood pressure remains 182/108 mmHg after repeated measurements.
Fields withheld from rule inputs: cardiovascular.blood_pressure.observed_diastolic, cardiovascular.blood_pressure.observed_systolic, diabetes.treatment_category, vision.diplopia.present, vision.visual_field.confirmed_defect

### cardiovascular.blood_pressure.observed_diastolic — omission

Independent source reading differs from the extraction. The GP's separate current summary records that persistent blood pressure remains 182/108 mmHg after repeated measurements.

Source lines 5–5; characters 528:873
> The GP's separate current summary records that persistent blood pressure remains 182/108 mmHg after repeated measurements. A measurement copied from an older employment form is lower, but the clinician identifies the repeated current values as persistent, and the nurse keeps the older form separate rather than averaging different time periods.

### cardiovascular.blood_pressure.observed_systolic — omission
...
Source lines 3–3; characters 56:526
> The patient has confirmed type 2 diabetes and is acutely unwell at the current assessment. The treating physician's signed note explicitly documents metabolically unstable diabetes after reviewing current observations and laboratory results; this is a documented clinical assessment rather than a diagnosis inferred by the nurse from thirst alone. The patient describes nausea and fluctuating blur, and the planned work assessment has been interrupted for clinical care.

### vision.diplopia.present — uncertainty

Independent source reading differs from the extraction. The patient describes fluctuating blur, but a visual FIELD defect has not been confirmed.
...
### HTN-COM-UNCONDITIONAL-001 — triggered

Persistent blood pressure exceeds the commercial unconditional-licence threshold.

- `cardiovascular.blood_pressure.persistent_diastolic` = 108.0 (present)
  - Source lines 5–5; chars 528:651: The GP's separate current summary records that persistent blood pressure remains 182/108 mmHg after repeated measurements. 
  - Source lines 5–5; chars 575:621: persistent blood pressure remains 182/108 mmHg
- `cardiovascular.blood_pressure.persistent_systolic` = 182.0 (present)
  - Source lines 5–5; chars 528:651: The GP's separate current summary records that persistent blood pressure remains 182/108 mmHg after repeated measurements. 
  - Source lines 5–5; chars 575:621: persistent blood pressure remains 182/108 mmHg
...
- `vision.visual_field.confirmed_defect` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 528:873: The GP's separate current summary records that persistent blood pressure remains 182/108 mmHg after repeated measurements. A measurement copied from an older employment form is lower, but the clinician identifies the repeated current values as persistent, and the nurse keeps the older form separate rather than averaging different time periods.
...
- `vision.diplopia.present` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 56:526: The patient has confirmed type 2 diabetes and is acutely unwell at the current assessment. The treating physician's signed note explicitly documents metabolically unstable diabetes after reviewing current observations and laboratory results; this is a documented clinical assessment rather than a diagnosis inferred by the nurse from thirst alone. The patient describes nausea and fluctuating blur, and the planned work assessment has been interrupted for clinical care.
...
- `diabetes.present` = True (present)
  - Source lines 3–3; chars 56:147: The patient has confirmed type 2 diabetes and is acutely unwell at the current assessment. 
  - Source lines 3–3; chars 56:147: The patient has confirmed type 2 diabetes and is acutely unwell at the current assessment. 
  - Source lines 3–3; chars 56:97: The patient has confirmed type 2 diabetes
...
- `diabetes.metabolically_unstable` = True (present)
  - Source lines 3–3; chars 147:298: The treating physician's signed note explicitly documents metabolically unstable diabetes after reviewing current observations and laboratory results; 
  - Source lines 3–3; chars 205:236: metabolically unstable diabetes
- `diabetes.present` = True (present)
  - Source lines 3–3; chars 56:147: The patient has confirmed type 2 diabetes and is acutely unwell at the current assessment. 
  - Source lines 3–3; chars 56:147: The patient has confirmed type 2 diabetes and is acutely unwell at the current assessment. 
  - Source lines 3–3; chars 56:97: The patient has confirmed type 2 diabetes
...
- [ ] Confirm missing/unverified case fact: cardiovascular.hypertension.antihypertensive_therapy
- [ ] Confirm missing/unverified case fact: cardiovascular.hypertension.controlled_for_4_weeks
- [ ] Confirm missing/unverified case fact: cardiovascular.hypertension.driving_impairing_medication_side_effects
- [ ] Confirm missing/unverified case fact: cardiovascular.hypertension.initial_specialist_information_available
- [ ] Confirm missing/unverified case fact: cardiovascular.hypertension.target_organ_damage_relevant_to_driving
...
The driver cannot provide a reliable account of the latest diabetes medication change or a complete glucose log, and the visual symptoms have not received an independent specialist assessment. Those missing details remain unresolved even though current metabolic instability and persistent blood pressure are explicitly documented by the treating clinicians.

```

Input SHA-256: `4362c9a0c560290ca28f7dd53a0d8593cc8f7cce50a04b90a6c94358b314ed16`
Rule-result SHA-256: `18af9be2a26abba90ffdf44cff3669dc1dd6ba03a675f92f900a42af030b1251`
Evidence-pack SHA-256: `e8e2ca4e0fb5431a4e7764d98f6db21d938180e1dbc7bcf708f7829fdc7f7472`
