# Clinical review draft — CX-MIX-11

CX-MIX-11: Insufficient information. 5 requested modules; 15 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
> His blood-pressure medicines were changed after BP 180/106 mmHg at a pharmacy last week, whereas today's BP 152/90 mmHg was measured only once; he reports occasional dizziness but no definite loss of consciousness.
...
> The driver says his hearing is adequate when both aids are working, although radio instructions become difficult after several hours and he sometimes removes the left aid because of discomfort; his supervisor reports missed instructions, while the driver attributes these to a damaged radio speaker. An unsigned worksheet states unaided better ear average 39 dB averaged over 0.5, 1, 2 and 3 kHz, but the driver remembers wearing at least one aid during testing and cannot confirm that the sheet belongs to the most recent appointment. The same folder contains an earlier note stating bilateral hearing loss and another form marked Hearing: normal, with no explanation of whether the statements refer to aided performance or unaided testing. There is no current audiologist report describing functional hearing with the aids, and the nurse has not accepted the recalled test conditions or selected the more favourable entry as definitive. He is unable to establish a stable period on the new regimen, and neither the symptom history nor the hearing discrepancy has been resolved by the available paperwork.
...
Confirm blackout.mechanism_status (omission): Independent source reading differs from the extraction. undetermined_after_investigation
Confirm blackout.occurred (omission): Independent source reading differs from the extraction. No
Confirm cardiovascular.blood_pressure.persistent_diastolic (omission): Independent source reading differs from the extraction. The patient's persistent diastolic blood pressure is 90 mmHg.
Confirm cardiovascular.blood_pressure.persistent_systolic (omission): Independent source reading differs from the extraction. The patient's blood pressure was measured at 152/90 mmHg, which is lower than the previous measurement of 180/106 mmHg. The patient reports occasional dizziness but no definite loss of consciousness. The blood pressure is not persistent systolic, as it has decreased since the previous measurement.
Confirm hearing.audiometry.available (uncertainty): Independent source reading differs from the extraction. The availability of the audiogram is uncertain due to conflicting information. The driver's supervisor reports missed instructions, while the driver attributes these to a damaged radio speaker. The unaided better ear average is 39 dB, but the driver remembers wearing at least one aid during testing and cannot confirm that the sheet belongs to the most recent appointment. There is no current audiologist report describing functional hearing with the aids.
Confirm hearing.average_frequencies_khz (unsupported): Independent source reading differs from the extraction. The directly relevant evidence is the unaided better ear average 39 dB averaged over 0.5, 1, 2 and 3 kHz. This is the only documented audiometry frequency in kHz.
Fields withheld from rule inputs: blackout.mechanism_status, blackout.occurred, cardiovascular.blood_pressure.persistent_diastolic, cardiovascular.blood_pressure.persistent_systolic, hearing.audiometry.available, hearing.average_frequencies_khz

### blackout.mechanism_status — omission

Independent source reading differs from the extraction. undetermined_after_investigation

Source lines 5–5; characters 603:1005
> The same folder contains an earlier note stating bilateral hearing loss and another form marked Hearing: normal, with no explanation of whether the statements refer to aided performance or unaided testing. There is no current audiologist report describing functional hearing with the aids, and the nurse has not accepted the recalled test conditions or selected the more favourable entry as definitive.

### blackout.occurred — omission

Independent source reading differs from the extraction. No

Source lines 7–7; characters 1007:1389
> His blood-pressure medicines were changed after BP 180/106 mmHg at a pharmacy last week, whereas today's BP 152/90 mmHg was measured only once; he reports occasional dizziness but no definite loss of consciousness. He is unable to establish a stable period on the new regimen, and neither the symptom history nor the hearing discrepancy has been resolved by the available paperwork.

### cardiovascular.blood_pressure.persistent_diastolic — omission

Independent source reading differs from the extraction. The patient's persistent diastolic blood pressure is 90 mmHg.
...
Independent source reading differs from the extraction. The availability of the audiogram is uncertain due to conflicting information. The driver's supervisor reports missed instructions, while the driver attributes these to a damaged radio speaker. The unaided better ear average is 39 dB, but the driver remembers wearing at least one aid during testing and cannot confirm that the sheet belongs to the most recent appointment. There is no current audiologist report describing functional hearing with the aids.

Source lines 3–3; characters 66:601
> The driver says his hearing is adequate when both aids are working, although radio instructions become difficult after several hours and he sometimes removes the left aid because of discomfort; his supervisor reports missed instructions, while the driver attributes these to a damaged radio speaker. An unsigned worksheet states unaided better ear average 39 dB averaged over 0.5, 1, 2 and 3 kHz, but the driver remembers wearing at least one aid during testing and cannot confirm that the sheet belongs to the most recent appointment.

### hearing.average_frequencies_khz — unsupported

Independent source reading differs from the extraction. The directly relevant evidence is the unaided better ear average 39 dB averaged over 0.5, 1, 2 and 3 kHz. This is the only documented audiometry frequency in kHz.

Source lines 3–3; characters 428:461
> averaged over 0.5, 1, 2 and 3 kHz
...
- `cardiovascular.blood_pressure.persistent_diastolic` = UNKNOWN (requires_confirmation)
  - Source lines 7–7; chars 1007:1389: His blood-pressure medicines were changed after BP 180/106 mmHg at a pharmacy last week, whereas today's BP 152/90 mmHg was measured only once; he reports occasional dizziness but no definite loss of consciousness. He is unable to establish a stable period on the new regimen, and neither the symptom history nor the hearing discrepancy has been resolved by the available paperwork.
...
- `blackout.mechanism_status` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 603:1005: The same folder contains an earlier note stating bilateral hearing loss and another form marked Hearing: normal, with no explanation of whether the statements refer to aided performance or unaided testing. There is no current audiologist report describing functional hearing with the aids, and the nurse has not accepted the recalled test conditions or selected the more favourable entry as definitive.
...
- `hearing.audiometry.available` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 66:601: The driver says his hearing is adequate when both aids are working, although radio instructions become difficult after several hours and he sometimes removes the left aid because of discomfort; his supervisor reports missed instructions, while the driver attributes these to a damaged radio speaker. An unsigned worksheet states unaided better ear average 39 dB averaged over 0.5, 1, 2 and 3 kHz, but the driver remembers wearing at least one aid during testing and cannot confirm that the sheet belongs to the most recent appointment.
- `hearing.clinical_assessment` = UNKNOWN (conflicting)
  - Source lines 5–5; chars 699:807: Hearing: normal, with no explanation of whether the statements refer to aided performance or unaided testing
  - Source lines 5–5; chars 652:674: bilateral hearing loss
...
- `hearing.average_frequencies_khz` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 428:461: averaged over 0.5, 1, 2 and 3 kHz
  - Source lines 3–3; chars 428:461: averaged over 0.5, 1, 2 and 3 kHz
- `hearing.clinical_assessment` = UNKNOWN (conflicting)
  - Source lines 5–5; chars 699:807: Hearing: normal, with no explanation of whether the statements refer to aided performance or unaided testing
  - Source lines 5–5; chars 652:674: bilateral hearing loss
- `hearing.unaided_better_ear_average_db` = UNKNOWN (requires_confirmation)
  - Source lines 3–4; chars 366:603: An unsigned worksheet states unaided better ear average 39 dB averaged over 0.5, 1, 2 and 3 kHz, but the driver remembers wearing at least one aid during testing and cannot confirm that the sheet belongs to the most recent appointment.  
...
Input SHA-256: `963614f5d644da8d0690493dc613b907200fc93d232d621c2a7db7889e7b8284`
Rule-result SHA-256: `edb07deeb9416fdc738347413d1fb7c15bcba284ec7377a16555a93c649c873c`
Evidence-pack SHA-256: `333c08f94100040ba98a325561807aab8efb7cd04fd944f39c595b6371cb9b9c`
