# Clinical review draft — VAL-MIX-04

VAL-MIX-04: Does not meet standard. 5 requested modules; 22 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
| vision | Does not meet standard | human_review | 5 |
| hearing | Insufficient information | missing_information | 3 |
| blackout | Insufficient information | human_review | 2 |
| diabetes | Insufficient information | missing_information | 10 |

## Retrieval activity

Rule-scoped ranking calls: 27.
...
> The driver has been adjusting meal times around split shifts and sometimes receives a sensor warning before feeling symptoms, but there is no documented recent episode requiring another person's assistance and no complete assessment of hypoglycaemia awareness in the material provided.
...
> The driver has established diabetes. The current specialist letter confirms that diabetes is managed with insulin and that the diabetes is not gestational. The driver has been adjusting meal times around split shifts and sometimes receives a sensor warning before feeling symptoms, but there is no documented recent episode requiring another person's assistance and no complete assessment of hypoglycaemia awareness in the material provided. A change of lenses has been proposed but not assessed, and the nurse has no updated specialist decision about the visual symptoms or the diabetes monitoring plan. The two confirmed findings are recorded independently; neither a successful lens adjustment nor adequate glucose control has been assumed.
...
> The ophthalmologist confirms non-physiological diplopia following a recent examination. Diplopia is present within 20 degrees of central fixation. The driver says the double image is more noticeable after prolonged night driving, yet the specialist reproduced it during daytime testing, so its absence during a short nursing interview is not treated as proof that the documented finding has resolved. A change of lenses has been proposed but not assessed, and the nurse has no updated specialist decision about the visual symptoms or the diabetes monitoring plan.
...
Confirm blackout.mechanism_status (omission): Independent source reading differs from the extraction. The driver has established diabetes. The current specialist letter confirms that diabetes is managed with insulin and that the diabetes is not gestational. The driver has been adjusting meal times around split shifts and sometimes receives a sensor warning before feeling symptoms, but there is no documented recent episode requiring another person's assistance and no complete assessment of hypoglycaemia awareness in the material provided.
Confirm blackout.occurred (omission): Independent source reading differs from the extraction. Not documented
Confirm vision.visual_field.confirmed_defect (omission): Independent source reading differs from the extraction. The question is about the confirmation of a visual field defect, not the presence of diplopia or reduced visual acuity. The passage 2 confirms the presence of non-physiological diplopia, but this does not establish a visual field defect. Therefore, the answer is: not documented.
Fields withheld from rule inputs: blackout.mechanism_status, blackout.occurred, vision.visual_field.confirmed_defect

### blackout.mechanism_status — omission

Independent source reading differs from the extraction. The driver has established diabetes. The current specialist letter confirms that diabetes is managed with insulin and that the diabetes is not gestational. The driver has been adjusting meal times around split shifts and sometimes receives a sensor warning before feeling symptoms, but there is no documented recent episode requiring another person's assistance and no complete assessment of hypoglycaemia awareness in the material provided.

Source lines 3–3; characters 56:497
> The driver has established diabetes. The current specialist letter confirms that diabetes is managed with insulin and that the diabetes is not gestational. The driver has been adjusting meal times around split shifts and sometimes receives a sensor warning before feeling symptoms, but there is no documented recent episode requiring another person's assistance and no complete assessment of hypoglycaemia awareness in the material provided.
...
Source lines 5–5; characters 499:899
> The ophthalmologist confirms non-physiological diplopia following a recent examination. Diplopia is present within 20 degrees of central fixation. The driver says the double image is more noticeable after prolonged night driving, yet the specialist reproduced it during daytime testing, so its absence during a short nursing interview is not treated as proof that the documented finding has resolved.
...
- `blackout.mechanism_status` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 56:497: The driver has established diabetes. The current specialist letter confirms that diabetes is managed with insulin and that the diabetes is not gestational. The driver has been adjusting meal times around split shifts and sometimes receives a sensor warning before feeling symptoms, but there is no documented recent episode requiring another person's assistance and no complete assessment of hypoglycaemia awareness in the material provided.
...
- `vision.visual_field.confirmed_defect` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 499:899: The ophthalmologist confirms non-physiological diplopia following a recent examination. Diplopia is present within 20 degrees of central fixation. The driver says the double image is more noticeable after prolonged night driving, yet the specialist reproduced it during daytime testing, so its absence during a short nursing interview is not treated as proof that the documented finding has resolved.
...
### VIS-COM-DIPLOPIA-001 — triggered

Non-physiological diplopia within 20 degrees of central fixation does not meet either commercial unconditional or conditional standards.

- `vision.diplopia.physiological` = False (present)
  - Source lines 5–5; chars 499:587: The ophthalmologist confirms non-physiological diplopia following a recent examination. 
- `vision.diplopia.present` = True (present)
  - Source lines 5–5; chars 499:587: The ophthalmologist confirms non-physiological diplopia following a recent examination. 
  - Source lines 5–5; chars 499:586: The ophthalmologist confirms non-physiological diplopia following a recent examination.
- `vision.diplopia.within_20_degrees` = True (present)
  - Source lines 5–5; chars 587:646: Diplopia is present within 20 degrees of central fixation. 
...
- `diabetes.gestational` = False (present)
  - Source lines 3–3; chars 93:212: The current specialist letter confirms that diabetes is managed with insulin and that the diabetes is not gestational. 
- `diabetes.present` = True (present)
  - Source lines 3–3; chars 56:93: The driver has established diabetes. 
  - Source lines 3–3; chars 56:93: The driver has established diabetes. 
  - Source lines 3–3; chars 56:92: The driver has established diabetes.
...
- [ ] Confirm missing/unverified case fact: diabetes.driving_relevant_end_organ_effects
- [ ] Confirm missing/unverified case fact: diabetes.glucose_monitoring_records_months
- [ ] Confirm missing/unverified case fact: diabetes.hypoglycaemia_awareness
- [ ] Confirm missing/unverified case fact: diabetes.metabolically_unstable
- [ ] Confirm missing/unverified case fact: diabetes.recent_severe_hypoglycaemic_event
- [ ] Confirm missing/unverified case fact: diabetes.regimen_minimises_hypoglycaemia
...
- [ ] Confirm missing/unverified case fact: diabetes.specialist_information_available
...
A change of lenses has been proposed but not assessed, and the nurse has no updated specialist decision about the visual symptoms or the diabetes monitoring plan. The two confirmed findings are recorded independently; neither a successful lens adjustment nor adequate glucose control has been assumed.

```

Input SHA-256: `43c91490fd5a48302fc376d3d4f25bcf121755d1240f947319bcdf0da41a3a34`
Rule-result SHA-256: `2bed76474d72af301d88c0466b402e983565a4499f66940ea5cefdeb14091f4d`
Evidence-pack SHA-256: `48b07cb86ec1cdda0743d046388c47e614bf27448fc897f4eca9fbb44dc6451a`
