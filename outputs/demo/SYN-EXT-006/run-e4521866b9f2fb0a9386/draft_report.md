# Clinical review draft — SYN-EXT-006

SYN-EXT-006: Temporarily unfit. 5 requested modules; 0 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
- `blackout.mechanism_status` = undetermined_after_investigation (present)
  - Source lines 16–16; chars 654:716: blackout.mechanism_status = "undetermined_after_investigation"
- `blackout.occurred` = True (present)
  - Source lines 14–14; chars 602:626: blackout.occurred = true
  - Source lines 14–14; chars 602:626: blackout.occurred = true

Guideline sources: [AFTD2022-BLK-COM-003](#aftd2022-blk-com-003)

### BLK-COM-RECURRENT-WAIT-001 — triggered

The ten-year event-free period for recurrent uncertain blackouts has not elapsed.

- `blackout.episodes_separated_by_24h_count` = 2 (present)
  - Source lines 18–18; chars 755:799: blackout.episodes_separated_by_24h_count = 2
- `blackout.mechanism_status` = undetermined_after_investigation (present)
  - Source lines 16–16; chars 654:716: blackout.mechanism_status = "undetermined_after_investigation"
- `blackout.occurred` = True (present)
  - Source lines 14–14; chars 602:626: blackout.occurred = true
  - Source lines 14–14; chars 602:626: blackout.occurred = true
- `blackout.years_since_last_event` = 9.99 (present)
  - Source lines 19–19; chars 801:839: blackout.years_since_last_event = 9.99
...
- `cardiovascular.blood_pressure.persistent_diastolic` = 80.0 (present)
  - Source lines 7–7; chars 308:363: cardiovascular.blood_pressure.persistent_diastolic = 80
  - Source lines 7–7; chars 308:363: cardiovascular.blood_pressure.persistent_diastolic = 80
- `cardiovascular.blood_pressure.persistent_systolic` = 120.0 (present)
  - Source lines 6–6; chars 251:306: cardiovascular.blood_pressure.persistent_systolic = 120
  - Source lines 6–6; chars 251:306: cardiovascular.blood_pressure.persistent_systolic = 120
...
- `vision.diplopia.present` = False (present)
  - Source lines 11–11; chars 494:525: vision.diplopia.present = false
  - Source lines 11–11; chars 494:525: vision.diplopia.present = false
- `vision.monocular` = False (present)
  - Source lines 12–12; chars 527:551: vision.monocular = false
- `vision.uncorrected.better_eye` = 6/6 (present)
  - Source lines 8–8; chars 365:405: vision.uncorrected.right.snellen = "6/6"
  - Source lines 9–9; chars 407:446: vision.uncorrected.left.snellen = "6/6"
...
- `vision.visual_field.confirmed_defect` = False (present)
  - Source lines 10–10; chars 448:492: vision.visual_field.confirmed_defect = false
  - Source lines 10–10; chars 448:492: vision.visual_field.confirmed_defect = false
...
- `hearing.clinical_assessment` = no_hearing_loss (present)
  - Source lines 13–13; chars 553:600: hearing.clinical_assessment = "no_hearing_loss"
  - Source lines 13–13; chars 553:600: hearing.clinical_assessment = "no_hearing_loss"
...
- `diabetes.present` = False (present)
  - Source lines 15–15; chars 628:652: diabetes.present = false
  - Source lines 15–15; chars 628:652: diabetes.present = false
...
blackout.years_since_last_event = 9.99
blackout.appropriate_specialist_information_available = true

```

Input SHA-256: `c069e5739806009b18d50cebff3b8b0669b47317f6de97d187b4b6395df8f6dc`
Rule-result SHA-256: `d9f48f441737c9db6ffd6d0d0ce16d7589796d674ad3fb41bee0445698e8f0fc`
Evidence-pack SHA-256: `c654f41bdad3971951c6c3d0664ef69e066de9cc43deb142b67a25c2ca1deba9`

## Unverified local-model commentary

This synthetic validation fixture presents a commercial driver assessment with recurrent uncertain blackouts, meeting the criteria for a temporarily unfit assessment outcome. The presence of hypertension, vision, and hearing modules, all meeting unconditional standards, does not alter the assessment outcome. The blackouts, although undetermined, are recurrent and separated by at least 24 hours, exceeding the 10-year event-free period. The clinician must review the case note and evidence to determine the appropriate next steps.
