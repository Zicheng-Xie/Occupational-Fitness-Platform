# Clinical review draft — CX-MIX-06

CX-MIX-06: Insufficient information. 5 requested modules; 15 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
> During review the driver describes increased thirst, frequent overnight urination and fluctuating blur over approximately three weeks, but says a diagnosis of diabetes has never been confirmed for him; his sister uses insulin, and he is concerned that this means he must have the same condition. The referral mentions possible diabetes and requests further assessment, but it does not document a confirmed diagnosis, diabetic eye disease or a treatment plan. His older occupational form states vision was satisfactory at that time; the nurse has not treated that statement as proof of present visual fitness or attributed the new symptoms to a particular metabolic cause.
...
- [AFTD2022-DM-COM-010, PDF 107](../../../../../../../data/knowledge/raw/ap_g56_22.pdf#page=107)
### vision symptom retrieval

> During review the driver describes increased thirst, frequent overnight urination and fluctuating blur over approximately three weeks, but says a diagnosis of diabetes has never been confirmed for him; his sister uses insulin, and he is concerned that this means he must have the same condition. He brought an optometry card from eight months ago recording corrected right eye 6/6 and left eye 6/9, yet says the current blur varies during the day and is sometimes accompanied by glare rather than two separate images. He denies a persistent double image, has not had a current visual field examination and cannot determine whether the symptoms change when either eye is covered. The referral mentions possible diabetes and requests further assessment, but it does not document a confirmed diagnosis, diabetic eye disease or a treatment plan. His older occupational form states vision was satisfactory at that time; the nurse has not treated that statement as proof of present visual fitness or attributed the new symptoms to a particular metabolic cause.
...
Confirm diabetes.present (uncertainty): Independent source reading differs from the extraction. The note does not confirm or deny the presence of diabetes.
Confirm diabetes.treatment_category (uncertainty): Independent source reading differs from the extraction. The note does not specify the treatment category.
Confirm vision.diplopia.present (uncertainty): Independent source reading differs from the extraction. The patient denies a persistent double image.
Confirm vision.uncorrected.better_eye (uncertainty): Independent source reading differs from the extraction. The patient's current blur varies during the day.
Confirm vision.uncorrected.right.snellen (uncertainty): Independent source reading differs from the extraction. The patient's current blur varies during the day.
Confirm vision.visual_field.confirmed_defect (uncertainty): Independent source reading differs from the extraction. The patient has not had a current visual field examination.
Fields withheld from rule inputs: diabetes.present, diabetes.treatment_category, vision.diplopia.present, vision.uncorrected.better_eye, vision.uncorrected.right.snellen, vision.visual_field.confirmed_defect

### diabetes.present — uncertainty

Independent source reading differs from the extraction. The note does not confirm or deny the presence of diabetes.
...
Independent source reading differs from the extraction. The note does not specify the treatment category.
...
Independent source reading differs from the extraction. The patient denies a persistent double image.

Source lines 5–5; characters 540:922
> He brought an optometry card from eight months ago recording corrected right eye 6/6 and left eye 6/9, yet says the current blur varies during the day and is sometimes accompanied by glare rather than two separate images. He denies a persistent double image, has not had a current visual field examination and cannot determine whether the symptoms change when either eye is covered.

### vision.uncorrected.better_eye — uncertainty

Independent source reading differs from the extraction. The patient's current blur varies during the day.
...
Independent source reading differs from the extraction. The patient has not had a current visual field examination.
...
- `vision.uncorrected.better_eye` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 540:922: He brought an optometry card from eight months ago recording corrected right eye 6/6 and left eye 6/9, yet says the current blur varies during the day and is sometimes accompanied by glare rather than two separate images. He denies a persistent double image, has not had a current visual field examination and cannot determine whether the symptoms change when either eye is covered.
...
During review the driver describes increased thirst, frequent overnight urination and fluctuating blur over approximately three weeks, but says a diagnosis of diabetes has never been confirmed for him; his sister uses insulin, and he is concerned that this means he must have the same condition. A borrowed meter showed 16.9 mmol/L shortly after a meal, whereas another reading the next morning was 8.1 mmol/L, with no verified technique or accompanying laboratory report.

He brought an optometry card from eight months ago recording corrected right eye 6/6 and left eye 6/9, yet says the current blur varies during the day and is sometimes accompanied by glare rather than two separate images. He denies a persistent double image, has not had a current visual field examination and cannot determine whether the symptoms change when either eye is covered.

The referral mentions possible diabetes and requests further assessment, but it does not document a confirmed diagnosis, diabetic eye disease or a treatment plan. His older occupational form states vision was satisfactory at that time; the nurse has not treated that statement as proof of present visual fitness or attributed the new symptoms to a particular metabolic cause.

```

Input SHA-256: `eeaf6ab0faf1c720c1cf8c866e27f431a791fa7704ebffbfd1d1fcaf20ecaea4`
Rule-result SHA-256: `b052111c8f6d619367041e0e34d0766289b90e5f7723f97418eb4f14a80b2458`
Evidence-pack SHA-256: `d6eb3c3b20cca3b0bab7549ca59c9033112f22e2cb646f82f030b29f454ee66d`
