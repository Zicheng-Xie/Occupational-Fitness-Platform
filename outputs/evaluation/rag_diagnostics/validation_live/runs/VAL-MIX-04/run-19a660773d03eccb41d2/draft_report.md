...
VAL-MIX-04: Does not meet standard. 5 requested modules; 17 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
| diabetes | Insufficient information | human_review | 5 |

## Retrieval activity

Rule-scoped ranking calls: 28.
...
Confirm diabetes.gestational (unsupported): Independent source reading differs from the extraction. No information provided about whether the diabetes is gestational.
Confirm vision.visual_field.confirmed_defect (omission): Independent source reading differs from the extraction. The ophthalmologist confirms non-physiological diplopia following a recent examination.
Fields withheld from rule inputs: diabetes.gestational, vision.visual_field.confirmed_defect

### diabetes.gestational — unsupported

Independent source reading differs from the extraction. No information provided about whether the diabetes is gestational.

Source lines 3–3; characters 93:212
> The current specialist letter confirms that diabetes is managed with insulin and that the diabetes is not gestational. 

### vision.visual_field.confirmed_defect — omission

Independent source reading differs from the extraction. The ophthalmologist confirms non-physiological diplopia following a recent examination.
...
- `diabetes.gestational` = UNKNOWN (requires_confirmation)
...
Rule-result SHA-256: `b574306236d04324c288a96541fe24428187ae2c7a46020d7e6c806e2b7039c6`
Evidence-pack SHA-256: `2b7776287120afd28401abd983a6862c6ccaced472bde590bf4a97a8df0dd7f9`
