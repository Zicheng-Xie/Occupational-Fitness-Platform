# Clinical review draft — VAL-MIX-01

VAL-MIX-01: Insufficient information. 5 requested modules; 17 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.

**DRAFT · pending_clinical_review · Clinical sign-off pending**

| Module | Provisional outcome | Route | Missing fields |
|---|---|---|---|
| hypertension | Insufficient information | missing_information | 5 |
...
> He denies current chest pain and has not experienced a definite blackout, although he occasionally feels light-headed when getting out of the cab.
...
> During today's conversation the driver reports difficulty understanding dispatch when the engine is running, and hearing screening suggests possible hearing loss. He brought an invoice for a hearing aid consultation rather than a completed test, and neither the better-ear average nor the required frequencies has been measured in the supplied record. The nurse distinguishes the verified persistent pressure from those unresolved questions and from the separate hearing complaint.
...
> The driver attends with a current signed GP summary and a three-week measurement log; after reviewing repeated seated measurements, the GP documents that current persistent blood pressure is 178/106 mmHg.
...
Confirm blackout.occurred (omission): Independent source reading differs from the extraction. The driver denies experiencing a definite blackout, although he occasionally feels light-headed when getting out of the cab.
Fields withheld from rule inputs: blackout.mechanism_status, blackout.occurred
...
Source lines 7–7; characters 989:1307
> The driver recently changed his shift pattern and medication schedule, but there is no specialist statement confirming four weeks of control or an assessment of treatment-related symptoms. The nurse distinguishes the verified persistent pressure from those unresolved questions and from the separate hearing complaint.

### blackout.occurred — omission

Independent source reading differs from the extraction. The driver denies experiencing a definite blackout, although he occasionally feels light-headed when getting out of the cab.

Source lines 3–3; characters 56:600
> The driver attends with a current signed GP summary and a three-week measurement log; after reviewing repeated seated measurements, the GP documents that current persistent blood pressure is 178/106 mmHg. The driver recalls a much lower reading after exercise last summer, but that recollection is recorded separately from the current verified log and does not replace its persistent measurements. He denies current chest pain and has not experienced a definite blackout, although he occasionally feels light-headed when getting out of the cab.
...
- `cardiovascular.blood_pressure.persistent_diastolic` = 106.0 (present)
  - Source lines 3–3; chars 142:261: after reviewing repeated seated measurements, the GP documents that current persistent blood pressure is 178/106 mmHg. 
  - Source lines 3–3; chars 210:259: current persistent blood pressure is 178/106 mmHg
- `cardiovascular.blood_pressure.persistent_systolic` = 178.0 (present)
  - Source lines 3–3; chars 142:261: after reviewing repeated seated measurements, the GP documents that current persistent blood pressure is 178/106 mmHg. 
  - Source lines 3–3; chars 210:259: current persistent blood pressure is 178/106 mmHg
...
- `blackout.mechanism_status` = UNKNOWN (requires_confirmation)
  - Source lines 7–7; chars 989:1307: The driver recently changed his shift pattern and medication schedule, but there is no specialist statement confirming four weeks of control or an assessment of treatment-related symptoms. The nurse distinguishes the verified persistent pressure from those unresolved questions and from the separate hearing complaint.
- `blackout.occurred` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 56:600: The driver attends with a current signed GP summary and a three-week measurement log; after reviewing repeated seated measurements, the GP documents that current persistent blood pressure is 178/106 mmHg. The driver recalls a much lower reading after exercise last summer, but that recollection is recorded separately from the current verified log and does not replace its persistent measurements. He denies current chest pain and has not experienced a definite blackout, although he occasionally feels light-headed when getting out of the cab.
...
### HEAR-COM-AUDIOMETRY-MISSING-001 — triggered

Possible hearing loss was identified, but audiometry is unavailable.

- `hearing.audiometry.available` = False (present)
  - Source lines 5–5; chars 765:799: No formal audiogram is available. 
- `hearing.clinical_assessment` = possible_hearing_loss (present)
  - Source lines 5–5; chars 641:763: reports difficulty understanding dispatch when the engine is running, and hearing screening suggests possible hearing loss
  - Source lines 5–5; chars 602:765: During today's conversation the driver reports difficulty understanding dispatch when the engine is running, and hearing screening suggests possible hearing loss. 
  - Source lines 5–5; chars 602:765: During today's conversation the driver reports difficulty understanding dispatch when the engine is running, and hearing screening suggests possible hearing loss. 
...
During today's conversation the driver reports difficulty understanding dispatch when the engine is running, and hearing screening suggests possible hearing loss. No formal audiogram is available. He brought an invoice for a hearing aid consultation rather than a completed test, and neither the better-ear average nor the required frequencies has been measured in the supplied record.

The driver recently changed his shift pattern and medication schedule, but there is no specialist statement confirming four weeks of control or an assessment of treatment-related symptoms. The nurse distinguishes the verified persistent pressure from those unresolved questions and from the separate hearing complaint.

```

Input SHA-256: `f555d3b95eba79ade954a319ea1f3f4912182bdc5a4faa13a651c60525b9d2d5`
Rule-result SHA-256: `26be786232f1249912ea5fe56c89831b20fa4d4fc16823579ac8d7abc423c1a6`
Evidence-pack SHA-256: `ba16760cdfc799a81a9c0877eb791ce257bd2292542e523309e8130e770e6c20`
