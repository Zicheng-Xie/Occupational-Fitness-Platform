# Clinical review draft — SYN-EXT-020

SYN-EXT-020: Meets unconditional standard. 5 requested modules; 0 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
- `cardiovascular.blood_pressure.persistent_diastolic` = 80.0 (present)
  - Source lines 7–7; chars 290:345: cardiovascular.blood_pressure.persistent_diastolic = 80
  - Source lines 7–7; chars 290:345: cardiovascular.blood_pressure.persistent_diastolic = 80
- `cardiovascular.blood_pressure.persistent_systolic` = 120.0 (present)
  - Source lines 6–6; chars 233:288: cardiovascular.blood_pressure.persistent_systolic = 120
  - Source lines 6–6; chars 233:288: cardiovascular.blood_pressure.persistent_systolic = 120
...
- `vision.diplopia.present` = False (present)
  - Source lines 11–11; chars 476:507: vision.diplopia.present = false
  - Source lines 11–11; chars 476:507: vision.diplopia.present = false
- `vision.monocular` = False (present)
  - Source lines 12–12; chars 509:533: vision.monocular = false
- `vision.uncorrected.better_eye` = 6/6 (present)
  - Source lines 8–8; chars 347:387: vision.uncorrected.right.snellen = "6/6"
  - Source lines 9–9; chars 389:428: vision.uncorrected.left.snellen = "6/6"
...
- `vision.visual_field.confirmed_defect` = False (present)
  - Source lines 10–10; chars 430:474: vision.visual_field.confirmed_defect = false
  - Source lines 10–10; chars 430:474: vision.visual_field.confirmed_defect = false
...
- `hearing.average_frequencies_khz` = [0.5, 1, 2, 3] (present)
  - Source lines 18–18; chars 726:774: hearing.average_frequencies_khz = [0.5, 1, 2, 3]
- `hearing.clinical_assessment` = possible_hearing_loss (present)
  - Source lines 13–13; chars 535:588: hearing.clinical_assessment = "possible_hearing_loss"
  - Source lines 13–13; chars 535:588: hearing.clinical_assessment = "possible_hearing_loss"
- `hearing.unaided_better_ear_average_db` = 39.9 (present)
  - Source lines 17–17; chars 680:724: hearing.unaided_better_ear_average_db = 39.9
...
- `blackout.occurred` = False (present)
  - Source lines 14–14; chars 590:615: blackout.occurred = false
...
- `diabetes.present` = False (present)
  - Source lines 15–15; chars 617:641: diabetes.present = false
  - Source lines 15–15; chars 617:641: diabetes.present = false
...
Input SHA-256: `3a8c533677ee02e78c35a3802e8120bf12e944410323c3f2e5e6bfcc974b3104`
Rule-result SHA-256: `856697b4ffe1b0758a4f5f692c5e6286e2b57e5bbc5a5ebe27870136ff07dc31`
Evidence-pack SHA-256: `27b12f8da6a961dea0f419f80dfc93c16604565b3f5424e8f3fa2e32c4dad7d8`

## Unverified local-model commentary

This synthetic validation fixture meets the unconditional standard for a commercial driver assessment. The patient's blood pressure is within the normal range, and their uncorrected visual acuity is 6/6 in both eyes. There is no visual field defect or diplopia. The patient's hearing is assessed as possible hearing loss, but audiometry is available. There is no history of blackout or diabetes. The patient meets the standard for an unconditional licence.
