# Clinical review draft — CX-MIX-04

CX-MIX-04: Insufficient information. 5 requested modules; 15 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
Rule-scoped ranking calls: 33.
Symptom discovery searches: 2.
Zero triggered rules does not mean retrieval failed. Retrieved text is not a diagnosis.

### hearing symptom retrieval

> He also reports difficulty understanding dispatch over the radio despite following quiet conversation in the consulting room, and says his right hearing aid was being repaired when a recent screening was performed. A phone image contains thresholds of 30, 45 and 55 dB without a complete frequency axis, an identifiable better ear or a clear statement about hearing aids; the nurse cannot derive the required unaided average from it. The driver denies a constant visual problem and says his hearing was considered normal two years earlier, but his supervisor describes missed spoken instructions and hesitation when checking mirrors during the last month. Updated optometry and audiology reports are pending, and the apparent difference between earlier records and current functional symptoms has not been reconciled.
...
> The driver says road signs are readable at the beginning of a shift but become doubled after several hours, particularly when looking toward the right mirror; covering one eye sometimes helps, although he is not certain which eye he covers and the symptom did not occur during today's interview. A photocopied eye assessment lists right 6/9 and left 6/18 beside the word unaided, with a separate handwritten 6/6 that is not assigned to an eye or clearly labelled as corrected vision. The driver denies a constant visual problem and says his hearing was considered normal two years earlier, but his supervisor describes missed spoken instructions and hesitation when checking mirrors during the last month. Updated optometry and audiology reports are pending, and the apparent difference between earlier records and current functional symptoms has not been reconciled.
...
Confirm hearing.audiometry.available (uncertainty): Independent source reading differs from the extraction. The note mentions a phone image contains thresholds of 30, 45 and 55 dB without a complete frequency axis, an identifiable better ear or a clear statement about hearing aids; the nurse cannot derive the required unaided average from it.
Confirm hearing.clinical_assessment (unsupported): Independent source reading differs from the extraction. The note mentions difficulty understanding dispatch over the radio despite following quiet conversation in the consulting room, and says his right hearing aid was being repaired when a recent screening was performed.
Confirm hearing.unaided_better_ear_average_db (uncertainty): Independent source reading differs from the extraction. The phone image contains thresholds of 30, 45 and 55 dB without a complete frequency axis, an identifiable better ear or a clear statement about hearing aids; the nurse cannot derive the required unaided average from it.
Confirm vision.diplopia.present (uncertainty): Independent source reading differs from the extraction. The note mentions that road signs are readable at the beginning of a shift but become doubled after several hours, particularly when looking toward the right mirror; covering one eye sometimes helps, although he is not certain which eye he covers and the symptom did not occur during today's interview.
Confirm vision.uncorrected.left.snellen (uncertainty): Independent source reading differs from the extraction. The note mentions a photocopied eye assessment lists right 6/9 and left 6/18 beside the word unaided, with a separate handwritten 6/6 that is not assigned to an eye or clearly labelled as corrected vision.
Confirm vision.uncorrected.right.snellen (uncertainty): Independent source reading differs from the extraction. The note mentions a photocopied eye assessment lists right 6/9 and left 6/18 beside the word unaided, with a separate handwritten 6/6 that is not assigned to an eye or clearly labelled as corrected vision.
Confirm vision.visual_field.confirmed_defect (uncertainty): Independent source reading differs from the extraction. The note mentions 'doubled' road signs after several hours, but the driver is not certain which eye is affected, and the symptom did not occur during the interview. This information is uncertain and does not provide a clear confirmation of a visual field defect.
Fields withheld from rule inputs: hearing.audiometry.available, hearing.clinical_assessment, hearing.unaided_better_ear_average_db, vision.diplopia.present, vision.uncorrected.left.snellen, vision.uncorrected.right.snellen, vision.visual_field.confirmed_defect

### hearing.audiometry.available — uncertainty

Independent source reading differs from the extraction. The note mentions a phone image contains thresholds of 30, 45 and 55 dB without a complete frequency axis, an identifiable better ear or a clear statement about hearing aids; the nurse cannot derive the required unaided average from it.

Source lines 5–5; characters 551:984
> He also reports difficulty understanding dispatch over the radio despite following quiet conversation in the consulting room, and says his right hearing aid was being repaired when a recent screening was performed. A phone image contains thresholds of 30, 45 and 55 dB without a complete frequency axis, an identifiable better ear or a clear statement about hearing aids; the nurse cannot derive the required unaided average from it.

### hearing.clinical_assessment — unsupported

Independent source reading differs from the extraction. The note mentions difficulty understanding dispatch over the radio despite following quiet conversation in the consulting room, and says his right hearing aid was being repaired when a recent screening was performed.

Source lines 3–3; characters 66:549
> The driver says road signs are readable at the beginning of a shift but become doubled after several hours, particularly when looking toward the right mirror; covering one eye sometimes helps, although he is not certain which eye he covers and the symptom did not occur during today's interview. A photocopied eye assessment lists right 6/9 and left 6/18 beside the word unaided, with a separate handwritten 6/6 that is not assigned to an eye or clearly labelled as corrected vision.

### hearing.unaided_better_ear_average_db — uncertainty

Independent source reading differs from the extraction. The phone image contains thresholds of 30, 45 and 55 dB without a complete frequency axis, an identifiable better ear or a clear statement about hearing aids; the nurse cannot derive the required unaided average from it.
...
Independent source reading differs from the extraction. The note mentions that road signs are readable at the beginning of a shift but become doubled after several hours, particularly when looking toward the right mirror; covering one eye sometimes helps, although he is not certain which eye he covers and the symptom did not occur during today's interview.
...
Independent source reading differs from the extraction. The note mentions a photocopied eye assessment lists right 6/9 and left 6/18 beside the word unaided, with a separate handwritten 6/6 that is not assigned to an eye or clearly labelled as corrected vision.
...
### vision.visual_field.confirmed_defect — uncertainty

Independent source reading differs from the extraction. The note mentions 'doubled' road signs after several hours, but the driver is not certain which eye is affected, and the symptom did not occur during the interview. This information is uncertain and does not provide a clear confirmation of a visual field defect.
...
- `vision.uncorrected.left.snellen` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 66:549: The driver says road signs are readable at the beginning of a shift but become doubled after several hours, particularly when looking toward the right mirror; covering one eye sometimes helps, although he is not certain which eye he covers and the symptom did not occur during today's interview. A photocopied eye assessment lists right 6/9 and left 6/18 beside the word unaided, with a separate handwritten 6/6 that is not assigned to an eye or clearly labelled as corrected vision.
...
- `hearing.audiometry.available` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 551:984: He also reports difficulty understanding dispatch over the radio despite following quiet conversation in the consulting room, and says his right hearing aid was being repaired when a recent screening was performed. A phone image contains thresholds of 30, 45 and 55 dB without a complete frequency axis, an identifiable better ear or a clear statement about hearing aids; the nurse cannot derive the required unaided average from it.
- `hearing.clinical_assessment` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 551:766: He also reports difficulty understanding dispatch over the radio despite following quiet conversation in the consulting room, and says his right hearing aid was being repaired when a recent screening was performed. 
  - Source lines 3–3; chars 66:549: The driver says road signs are readable at the beginning of a shift but become doubled after several hours, particularly when looking toward the right mirror; covering one eye sometimes helps, although he is not certain which eye he covers and the symptom did not occur during today's interview. A photocopied eye assessment lists right 6/9 and left 6/18 beside the word unaided, with a separate handwritten 6/6 that is not assigned to an eye or clearly labelled as corrected vision.
...
The driver denies a constant visual problem and says his hearing was considered normal two years earlier, but his supervisor describes missed spoken instructions and hesitation when checking mirrors during the last month. Updated optometry and audiology reports are pending, and the apparent difference between earlier records and current functional symptoms has not been reconciled.

```

Input SHA-256: `cf01d846ccf2d9b5463c7f44548387b7041815f6ca87684033a655c66ea68b9e`
Rule-result SHA-256: `c5002ee914583b38f546f2a42d76e8d70e93686059ea43360fd9859a3c61d2ac`
Evidence-pack SHA-256: `3adeae994c61eae4fbb7a7a6bcfdb6997a96034bbaf0e9bd6d85e6312f304ce2`
