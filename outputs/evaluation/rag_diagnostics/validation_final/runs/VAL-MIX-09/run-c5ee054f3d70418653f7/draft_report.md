...
Confirm cardiovascular.blood_pressure.observed_diastolic (uncertainty): Independent source reading differs from the extraction. The note mentions a single home blood-pressure display of 179/103, but the cuff size is unknown and today's resting measurement has not been repeated; no clinician has established persistent hypertension.
Confirm cardiovascular.blood_pressure.observed_systolic (uncertainty): Independent source reading differs from the extraction. The note mentions a single home blood-pressure display of 179/103, but the cuff size is unknown and today's resting measurement has not been repeated; no clinician has established persistent hypertension.
Confirm hearing.audiometry.available (uncertainty): Independent source reading differs from the extraction. The note does not explicitly state whether a formal audiogram is available, so the status is uncertain and the value is null.
Confirm hearing.clinical_assessment (uncertainty): Independent source reading differs from the extraction. The note does not explicitly state a hearing diagnosis, so the status is uncertain and the value is null.
Fields withheld from rule inputs: cardiovascular.blood_pressure.observed_diastolic, cardiovascular.blood_pressure.observed_systolic, hearing.audiometry.available, hearing.clinical_assessment

### cardiovascular.blood_pressure.observed_diastolic — uncertainty

Independent source reading differs from the extraction. The note mentions a single home blood-pressure display of 179/103, but the cuff size is unknown and today's resting measurement has not been repeated; no clinician has established persistent hypertension.
...
Independent source reading differs from the extraction. The note does not explicitly state whether a formal audiogram is available, so the status is uncertain and the value is null.
...
Independent source reading differs from the extraction. The note does not explicitly state a hearing diagnosis, so the status is uncertain and the value is null.
...
Rule-result SHA-256: `499b567f7e1b3971f1e8d5e4e63db000a317677be096c247a26e7c5621556858`
Evidence-pack SHA-256: `78f7834e56e5f0162f033bbd3db8bb078c05a5efd2bb265836557fae60f0a05e`
