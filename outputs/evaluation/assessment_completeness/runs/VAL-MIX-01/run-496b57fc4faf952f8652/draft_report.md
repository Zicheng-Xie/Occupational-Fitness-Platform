...
2 rules triggered from source-supported facts. The overall assessment is incomplete; this does not erase the findings below. Missing facts in any requested module can prevent an overall clearance.

- hypertension: `HTN-COM-UNCONDITIONAL-001` - Persistent blood pressure exceeds the commercial unconditional-licence threshold.
- hearing: `HEAR-COM-AUDIOMETRY-MISSING-001` - Possible hearing loss was identified, but audiometry is unavailable.

## Information coverage

- hypertension: Source-supported facts available; some facts require confirmation; 2 supported fields; 5 unresolved rule fields.
- vision: No source-supported facts for this requested module; 0 supported fields; 6 unresolved rule fields.
- hearing: Source-supported facts available; 2 supported fields; 2 unresolved rule fields.
- blackout: No source-supported facts for this requested module; 0 supported fields; 2 unresolved rule fields.
- diabetes: No source-supported facts for this requested module; 0 supported fields; 2 unresolved rule fields.
...
Confirm cardiovascular.chest_pain (unsupported): Independent source reading differs from the extraction. The patient denies current chest pain.
Fields withheld from rule inputs: cardiovascular.chest_pain

### cardiovascular.chest_pain — unsupported

Independent source reading differs from the extraction. The patient denies current chest pain.

Source lines 3–3; characters 457:482
> denies current chest pain
...
Rule-result SHA-256: `17e16ffb2fc4c35a2e3be70992f8eefe0c9a2c81aa870a4ee69347e330ff74ae`
Evidence-pack SHA-256: `7105d68ac82fd95731c90de46436fbeb039987683ee384ed8db3588e2c472d66`
