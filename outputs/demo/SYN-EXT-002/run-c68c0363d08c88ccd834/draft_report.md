# Clinical review draft — SYN-EXT-002

SYN-EXT-002: Insufficient information. 5 requested modules; 5 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
- `cardiovascular.blood_pressure.persistent_diastolic` = 100 (present)
  - Source lines 7–7; chars 329:385: cardiovascular.blood_pressure.persistent_diastolic = 100
- `cardiovascular.blood_pressure.persistent_systolic` = 171 (present)
  - Source lines 6–6; chars 272:327: cardiovascular.blood_pressure.persistent_systolic = 171
...
- `vision.diplopia.present` = False (present)
  - Source lines 11–11; chars 516:547: vision.diplopia.present = false
  - Source lines 11–11; chars 516:547: vision.diplopia.present = false
- `vision.monocular` = False (present)
  - Source lines 12–12; chars 549:573: vision.monocular = false
- `vision.uncorrected.better_eye` = 6/6 (present)
  - Source lines 8–8; chars 387:427: vision.uncorrected.right.snellen = "6/6"
  - Source lines 9–9; chars 429:468: vision.uncorrected.left.snellen = "6/6"
...
- `vision.visual_field.confirmed_defect` = False (present)
  - Source lines 10–10; chars 470:514: vision.visual_field.confirmed_defect = false
  - Source lines 10–10; chars 470:514: vision.visual_field.confirmed_defect = false
...
- `hearing.clinical_assessment` = no_hearing_loss (present)
  - Source lines 13–13; chars 575:622: hearing.clinical_assessment = "no_hearing_loss"
  - Source lines 13–13; chars 575:622: hearing.clinical_assessment = "no_hearing_loss"
...
Input SHA-256: `7c8dcec286991b0384801889b7d6d9e5c28d0a4fc48d9a1bb56454ce9de35176`
Rule-result SHA-256: `c487ed746333e0b846e3927d24708431f7bceef7f8276a495a359327ca7c6e31`
Evidence-pack SHA-256: `3030cac275f28f1dfaa4c7fc35727038f3b63265a88b82c65c091bdbd41a4907`

## Unverified local-model commentary

This commercial driver assessment is incomplete due to insufficient information regarding hypertension. The persistent systolic pressure is just above the commercial boundary, and conditional follow-up is not documented. A clinician must review the case to determine the driver's fitness to hold a licence.
