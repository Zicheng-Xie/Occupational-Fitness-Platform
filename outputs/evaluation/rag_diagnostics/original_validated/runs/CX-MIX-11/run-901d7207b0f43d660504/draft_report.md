...
Confirm blackout.mechanism_status (uncertainty): Independent source reading differs from the extraction. Uncertain, disputed, historical-only or unreliable measurements have status uncertain and value null.
Confirm blackout.occurred (uncertainty): Independent source reading differs from the extraction. Uncertain, disputed, historical-only or unreliable measurements have status uncertain and value null.
Confirm hearing.audiometry.available (uncertainty): Independent source reading differs from the extraction. Uncertain, disputed, historical-only or unreliable measurements have status uncertain and value null.
Confirm hearing.average_frequencies_khz (unsupported): Independent source reading differs from the extraction. Uncertain, disputed, historical-only or unreliable measurements have status uncertain and value null.
Fields withheld from rule inputs: blackout.mechanism_status, blackout.occurred, hearing.audiometry.available, hearing.average_frequencies_khz
...
Rule-result SHA-256: `d159ac37c086d828f7a4ffc0b7450cbad07d1a9490d0503dabe160be7b61a55f`
Evidence-pack SHA-256: `70c54215b143807314d071d3fbcc26ec68f9c20579f9579fece053b59beabc4d`
