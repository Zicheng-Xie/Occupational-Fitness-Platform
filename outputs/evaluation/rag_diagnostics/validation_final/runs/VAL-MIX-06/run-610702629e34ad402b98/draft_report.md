# Clinical review draft — VAL-MIX-06

VAL-MIX-06: Insufficient information. 5 requested modules; 19 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
| vision | Insufficient information | human_review | 10 |
| hearing | Insufficient information | missing_information | 3 |
| blackout | Insufficient information | human_review | 2 |
| diabetes | Insufficient information | human_review | 2 |

## Retrieval activity

Rule-scoped ranking calls: 32.
Symptom discovery searches: 3.
Zero triggered rules does not mean retrieval failed. Retrieved text is not a diagnosis.

### blackout symptom retrieval

> The driver had transient loss of consciousness while seated after a delivery, with a colleague documenting failure to respond and a brief gap in recall. An emergency differential mentions arrhythmia and seizure without confirming either, and a glucose measurement obtained after food cannot establish the cause of the event. The driver is unsure whether a remote dizzy spell involved loss of awareness, so the number of confirmed events and the appropriate event-free interval remain unresolved despite documentation of the recent event and the visual field defect.

- [AFTD2022-BLK-COM-002, PDF 68](../../../../../../../data/knowledge/raw/ap_g56_22.pdf#page=68)
...
> An emergency differential mentions arrhythmia and seizure without confirming either, and a glucose measurement obtained after food cannot establish the cause of the event.

- [AFTD2022-DM-COM-002, PDF 105](../../../../../../../data/knowledge/raw/ap_g56_22.pdf#page=105)
- [AFTD2022-DM-COM-001, PDF 103](../../../../../../../data/knowledge/raw/ap_g56_22.pdf#page=103)
...
> The optometrist confirms a visual field defect on a separate current signed assessment. The driver is unsure whether a remote dizzy spell involved loss of awareness, so the number of confirmed events and the appropriate event-free interval remain unresolved despite documentation of the recent event and the visual field defect.
...
- [AFTD2022-VIS-COM-007, PDF 222](../../../../../../../data/knowledge/raw/ap_g56_22.pdf#page=222)
...
Confirm blackout.mechanism_status (unsupported): Independent source reading differs from the extraction. The mechanism is under investigation, but the cause is unknown.
Confirm blackout.occurred (unsupported): Independent source reading differs from the extraction. The event is described as transient loss of consciousness, but the cause is not confirmed.
Confirm diabetes.present (uncertainty): Independent source reading differs from the extraction. A glucose measurement was obtained after food, but it cannot establish the cause of the event.
Confirm diabetes.treatment_category (uncertainty): Independent source reading differs from the extraction. The driver has a visual field defect, but the extent and stability are not yet documented.
Confirm vision.diplopia.present (uncertainty): Independent source reading differs from the extraction. The driver occasionally notices vehicles late on the left, but the significance of this is not clear.
Confirm vision.uncorrected.better_eye (uncertainty): Independent source reading differs from the extraction. The driver's uncorrected better eye acuity is not explicitly documented.
Confirm vision.uncorrected.left.snellen (uncertainty): Independent source reading differs from the extraction. Uncertainty about a disease from symptoms.
Confirm vision.uncorrected.right.snellen (uncertainty): Independent source reading differs from the extraction. Uncertainty about a disease from symptoms.
Fields withheld from rule inputs: blackout.mechanism_status, blackout.occurred, diabetes.present, diabetes.treatment_category, vision.diplopia.present, vision.uncorrected.better_eye, vision.uncorrected.left.snellen, vision.uncorrected.right.snellen

### blackout.mechanism_status — unsupported

Independent source reading differs from the extraction. The mechanism is under investigation, but the cause is unknown.

Source lines 1–1; characters 0:54
> Synthetic validation nurse note. No real patient data.

### blackout.occurred — unsupported

Independent source reading differs from the extraction. The event is described as transient loss of consciousness, but the cause is not confirmed.

Source lines 3–3; characters 56:461
> The driver had transient loss of consciousness while seated after a delivery, with a colleague documenting failure to respond and a brief gap in recall. The current physician referral states that the mechanism is under investigation. An emergency differential mentions arrhythmia and seizure without confirming either, and a glucose measurement obtained after food cannot establish the cause of the event.

### diabetes.present — uncertainty

Independent source reading differs from the extraction. A glucose measurement was obtained after food, but it cannot establish the cause of the event.

Source lines 3–3; characters 56:461
> The driver had transient loss of consciousness while seated after a delivery, with a colleague documenting failure to respond and a brief gap in recall. The current physician referral states that the mechanism is under investigation. An emergency differential mentions arrhythmia and seizure without confirming either, and a glucose measurement obtained after food cannot establish the cause of the event.

### diabetes.treatment_category — uncertainty

Independent source reading differs from the extraction. The driver has a visual field defect, but the extent and stability are not yet documented.

Source lines 5–5; characters 463:818
> The optometrist confirms a visual field defect on a separate current signed assessment. The driver describes occasionally noticing vehicles late on the left, although central letters remain clear; a specialist has not yet documented whether the defect is stable, its complete binocular horizontal extent or whether other significant field loss is present.

### vision.diplopia.present — uncertainty

Independent source reading differs from the extraction. The driver occasionally notices vehicles late on the left, but the significance of this is not clear.

Source lines 5–5; characters 463:818
> The optometrist confirms a visual field defect on a separate current signed assessment. The driver describes occasionally noticing vehicles late on the left, although central letters remain clear; a specialist has not yet documented whether the defect is stable, its complete binocular horizontal extent or whether other significant field loss is present.

### vision.uncorrected.better_eye — uncertainty

Independent source reading differs from the extraction. The driver's uncorrected better eye acuity is not explicitly documented.

Source lines 5–5; characters 463:818
> The optometrist confirms a visual field defect on a separate current signed assessment. The driver describes occasionally noticing vehicles late on the left, although central letters remain clear; a specialist has not yet documented whether the defect is stable, its complete binocular horizontal extent or whether other significant field loss is present.

### vision.uncorrected.left.snellen — uncertainty

Independent source reading differs from the extraction. Uncertainty about a disease from symptoms.

Source lines 5–5; characters 463:818
> The optometrist confirms a visual field defect on a separate current signed assessment. The driver describes occasionally noticing vehicles late on the left, although central letters remain clear; a specialist has not yet documented whether the defect is stable, its complete binocular horizontal extent or whether other significant field loss is present.

### vision.uncorrected.right.snellen — uncertainty
...
- `blackout.mechanism_status` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 252:288: the mechanism is under investigation
  - Source lines 3–3; chars 209:290: The current physician referral states that the mechanism is under investigation. 
  - Source lines 1–1; chars 0:54: Synthetic validation nurse note. No real patient data.
- `blackout.occurred` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 56:209: The driver had transient loss of consciousness while seated after a delivery, with a colleague documenting failure to respond and a brief gap in recall. 
  - Source lines 3–3; chars 56:208: The driver had transient loss of consciousness while seated after a delivery, with a colleague documenting failure to respond and a brief gap in recall.
  - Source lines 3–3; chars 56:461: The driver had transient loss of consciousness while seated after a delivery, with a colleague documenting failure to respond and a brief gap in recall. The current physician referral states that the mechanism is under investigation. An emergency differential mentions arrhythmia and seizure without confirming either, and a glucose measurement obtained after food cannot establish the cause of the event.
...
- `vision.uncorrected.better_eye` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 463:818: The optometrist confirms a visual field defect on a separate current signed assessment. The driver describes occasionally noticing vehicles late on the left, although central letters remain clear; a specialist has not yet documented whether the defect is stable, its complete binocular horizontal extent or whether other significant field loss is present.
...
### VIS-COM-FIELD-UNCONDITIONAL-001 — triggered

A confirmed visual field defect does not meet the commercial unconditional standard.

- `vision.visual_field.confirmed_defect` = True (present)
  - Source lines 5–5; chars 463:551: The optometrist confirms a visual field defect on a separate current signed assessment. 
  - Source lines 5–5; chars 463:550: The optometrist confirms a visual field defect on a separate current signed assessment.
...
- `diabetes.present` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 56:461: The driver had transient loss of consciousness while seated after a delivery, with a colleague documenting failure to respond and a brief gap in recall. The current physician referral states that the mechanism is under investigation. An emergency differential mentions arrhythmia and seizure without confirming either, and a glucose measurement obtained after food cannot establish the cause of the event.
...
- [ ] Confirm missing/unverified case fact: vision.specialist_assessment_available
...
- [ ] Confirm missing/unverified case fact: vision.visual_field.binocular_horizontal_extent_degrees
- [ ] Confirm missing/unverified case fact: vision.visual_field.measured_within_10_degrees_vertical
- [ ] Confirm missing/unverified case fact: vision.visual_field.significant_loss_likely_to_impede_driving
- [ ] Confirm missing/unverified case fact: vision.visual_field.static_and_unlikely_to_progress_rapidly
...
An older report described satisfactory central acuity, but the nurse has not used it to overrule the newer field finding. The driver is unsure whether a remote dizzy spell involved loss of awareness, so the number of confirmed events and the appropriate event-free interval remain unresolved despite documentation of the recent event and the visual field defect.

```

Input SHA-256: `2acf6d137bd99a1b119afe7621804d1e81bef3af6c811b66a3197f5297edb276`
Rule-result SHA-256: `70ff2d78eb106dcc53b01df5c3f78e69186e5caae9abf5ae2ccd1172b70dcc08`
Evidence-pack SHA-256: `118900b4bb87cd6df0cbf75592b8225fa0a920eecf352105e195060ba3be2512`
