...
VAL-MIX-01: Insufficient information. 5 requested modules; 18 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
Confirm hearing.audiometry.available (unsupported): Independent source reading differs from the extraction. A formal audiogram is not available, but hearing screening suggests possible hearing loss.
Fields withheld from rule inputs: hearing.audiometry.available

### hearing.audiometry.available — unsupported

Independent source reading differs from the extraction. A formal audiogram is not available, but hearing screening suggests possible hearing loss.

Source lines 5–5; characters 602:987
...
- `hearing.audiometry.available` = UNKNOWN (requires_confirmation)
  ...
  - Source lines 5–5; chars 602:987: During today's conversation the driver reports difficulty understanding dispatch when the engine is running, and hearing screening suggests possible hearing loss. No formal audiogram is available. He brought an invoice for a hearing aid consultation rather than a completed test, and neither the better-ear average nor the required frequencies has been measured in the supplied record.
...
Rule-result SHA-256: `6a5962489e899f70c17b28749bb2599509a05a9e0529541c9240941c2d7a0cc0`
Evidence-pack SHA-256: `4ac189adc9b03d879f55213205d5946b8806e863e29aad0570b94f94c079243c`
