...
Confirm cardiovascular.blood_pressure.observed_diastolic (omission): Independent source reading differs from the extraction. persistent blood pressure remains 182/108 mmHg after repeated measurements.
Confirm cardiovascular.blood_pressure.observed_systolic (omission): Independent source reading differs from the extraction. persistent blood pressure remains 182/108 mmHg after repeated measurements.
Confirm diabetes.treatment_category (omission): Independent source reading differs from the extraction. The patient has confirmed type 2 diabetes and is acutely unwell at the current assessment.
Confirm vision.diplopia.present (uncertainty): Independent source reading differs from the extraction. The patient describes fluctuating blur, but the visual symptoms have not received an independent specialist assessment.
Confirm vision.visual_field.confirmed_defect (uncertainty): Independent source reading differs from the extraction. The patient describes fluctuating blur, but the visual symptoms have not received an independent specialist assessment.
...
Independent source reading differs from the extraction. persistent blood pressure remains 182/108 mmHg after repeated measurements.
...
Independent source reading differs from the extraction. The patient has confirmed type 2 diabetes and is acutely unwell at the current assessment.
...
Independent source reading differs from the extraction. The patient describes fluctuating blur, but the visual symptoms have not received an independent specialist assessment.
...
Rule-result SHA-256: `610ccf33556cc24688a4fe5885df668fe746c9940f23af04fab6363f02002e78`
Evidence-pack SHA-256: `213065484c5022a32aeb5f70d9894cfbd0441501e253d0e6054be7adda6ee233`
