# Clinical review draft — CX-MIX-09

CX-MIX-09: Insufficient information. 5 requested modules; 15 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
> Blood-pressure treatment was increased two weeks earlier after several elevated home readings, and he reports brief light-headedness when standing without a definite blackout.
...
> Blood-pressure treatment was increased two weeks earlier after several elevated home readings, and he reports brief light-headedness when standing without a definite blackout. Today's BP 162/96 mmHg is a single seated observation; the nurse has not attributed the visual complaints to blood pressure, established persistent hypertension from the available entries or treated the unreliable field result as a confirmed measurement.
...
> The driver reports that vehicles approaching from the left sometimes appear suddenly, although he can read the central letters on a chart and denies constant double vision; he also describes occasional overlapping headlights after long night shifts, which were absent during the consultation. He recalls being told that an old injury left one eye less useful, while an earlier letter records vision in both eyes and no current specialist opinion confirms monocularity. A handwritten acuity entry of 6/9 is not assigned to an eye or labelled as corrected, and the driver alternates between an older pair of glasses and a recently purchased pair during work. Today's BP 162/96 mmHg is a single seated observation; the nurse has not attributed the visual complaints to blood pressure, established persistent hypertension from the available entries or treated the unreliable field result as a confirmed measurement.
...
Confirm blackout.mechanism_status (omission): Independent source reading differs from the extraction. The driver reports brief light-headedness when standing without a definite blackout.
Confirm blackout.occurred (omission): Independent source reading differs from the extraction. false
Confirm cardiovascular.blood_pressure.persistent_diastolic (omission): Independent source reading differs from the extraction. The patient's blood pressure is 162/96 mmHg, which is a single seated observation. The nurse has not attributed the visual complaints to blood pressure, established persistent hypertension from the available entries or treated the unreliable field result as a confirmed measurement.
Confirm cardiovascular.blood_pressure.persistent_systolic (uncertainty): Independent source reading differs from the extraction. uncertain
Confirm vision.diplopia.present (omission): Independent source reading differs from the extraction. The patient explicitly has diplopia (double vision) as he reports that vehicles approaching from the left sometimes appear suddenly, and he also describes occasional overlapping headlights after long night shifts.
Confirm vision.visual_field.confirmed_defect (omission): Independent source reading differs from the extraction. The driver reports that vehicles approaching from the left sometimes appear suddenly, although he can read the central letters on a chart and denies constant double vision; he also describes occasional overlapping headlights after long night shifts, which were absent during the consultation. A field printout shows a binocular horizontal extent of 135 degrees, but carries a poor-fixation warning and does not clearly document the vertical test extent, central defects or whether the result is stable over time.
Fields withheld from rule inputs: blackout.mechanism_status, blackout.occurred, cardiovascular.blood_pressure.persistent_diastolic, cardiovascular.blood_pressure.persistent_systolic, vision.diplopia.present, vision.visual_field.confirmed_defect

### blackout.mechanism_status — omission

Independent source reading differs from the extraction. The driver reports brief light-headedness when standing without a definite blackout.

Source lines 7–7; characters 945:1375
> Blood-pressure treatment was increased two weeks earlier after several elevated home readings, and he reports brief light-headedness when standing without a definite blackout. Today's BP 162/96 mmHg is a single seated observation; the nurse has not attributed the visual complaints to blood pressure, established persistent hypertension from the available entries or treated the unreliable field result as a confirmed measurement.
...
Independent source reading differs from the extraction. The patient explicitly has diplopia (double vision) as he reports that vehicles approaching from the left sometimes appear suddenly, and he also describes occasional overlapping headlights after long night shifts.

Source lines 3–3; characters 66:578
> The driver reports that vehicles approaching from the left sometimes appear suddenly, although he can read the central letters on a chart and denies constant double vision; he also describes occasional overlapping headlights after long night shifts, which were absent during the consultation. A field printout shows a binocular horizontal extent of 135 degrees, but carries a poor-fixation warning and does not clearly document the vertical test extent, central defects or whether the result is stable over time.
...
- `cardiovascular.blood_pressure.persistent_diastolic` = UNKNOWN (requires_confirmation)
  - Source lines 7–7; chars 945:1375: Blood-pressure treatment was increased two weeks earlier after several elevated home readings, and he reports brief light-headedness when standing without a definite blackout. Today's BP 162/96 mmHg is a single seated observation; the nurse has not attributed the visual complaints to blood pressure, established persistent hypertension from the available entries or treated the unreliable field result as a confirmed measurement.
...
- `vision.visual_field.confirmed_defect` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 66:578: The driver reports that vehicles approaching from the left sometimes appear suddenly, although he can read the central letters on a chart and denies constant double vision; he also describes occasional overlapping headlights after long night shifts, which were absent during the consultation. A field printout shows a binocular horizontal extent of 135 degrees, but carries a poor-fixation warning and does not clearly document the vertical test extent, central defects or whether the result is stable over time.
...
He recalls being told that an old injury left one eye less useful, while an earlier letter records vision in both eyes and no current specialist opinion confirms monocularity. A handwritten acuity entry of 6/9 is not assigned to an eye or labelled as corrected, and the driver alternates between an older pair of glasses and a recently purchased pair during work.

Blood-pressure treatment was increased two weeks earlier after several elevated home readings, and he reports brief light-headedness when standing without a definite blackout. Today's BP 162/96 mmHg is a single seated observation; the nurse has not attributed the visual complaints to blood pressure, established persistent hypertension from the available entries or treated the unreliable field result as a confirmed measurement.

```

Input SHA-256: `38094015d33619734a74e02b82927dc6f6f9c126b5d793cd4be126aefa1ab6dd`
Rule-result SHA-256: `fa03a612aac7c41c90c34b59d2d04416c9e08ceea30370d30a106baa62637441`
Evidence-pack SHA-256: `0ffc5ffd3094277da46483447c51cf30086dfbc71c753b05af39fffd1f77e461`
