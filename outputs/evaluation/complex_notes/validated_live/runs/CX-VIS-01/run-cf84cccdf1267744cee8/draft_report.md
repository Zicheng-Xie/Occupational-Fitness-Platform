# Clinical review draft — CX-VIS-01

CX-VIS-01: Insufficient information. 1 requested modules; 6 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
Confirm vision.uncorrected.right.snellen (omission): Independent source reading differs from the extraction. The patient's uncorrected right eye vision is 6/12.
Confirm vision.uncorrected.left.snellen (omission): Independent source reading differs from the extraction. The patient's uncorrected left eye vision is 6/18.
Confirm vision.corrected.right.snellen (omission): Independent source reading differs from the extraction. The patient's corrected right eye vision is 6/6.
Confirm vision.corrected.left.snellen (omission): Independent source reading differs from the extraction. The patient's corrected left eye vision is 6/9.
Fields withheld from rule inputs: vision.corrected.left.snellen, vision.corrected.right.snellen, vision.uncorrected.left.snellen, vision.uncorrected.right.snellen

### vision.uncorrected.right.snellen — omission

Independent source reading differs from the extraction. The patient's uncorrected right eye vision is 6/12.

Source lines 3–3; characters 419:429
> right 6/12

### vision.uncorrected.left.snellen — omission

Independent source reading differs from the extraction. The patient's uncorrected left eye vision is 6/18.

Source lines 3–3; characters 434:443
> left 6/18

### vision.corrected.right.snellen — omission

Independent source reading differs from the extraction. The patient's corrected right eye vision is 6/6.

Source lines 3–3; characters 471:480
> right 6/6

### vision.corrected.left.snellen — omission

Independent source reading differs from the extraction. The patient's corrected left eye vision is 6/9.

Source lines 3–3; characters 485:493
> left 6/9
...
- `vision.uncorrected.left.snellen` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 434:443: left 6/18
- `vision.uncorrected.right.snellen` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 419:429: right 6/12
...
- `vision.diplopia.present` = UNKNOWN (requires_confirmation)
  - Source lines 1–2; chars 232:390: he reports no diplopia at rest, and the nurse has not established the angle from central fixation or whether the symptom persists with the updated lenses.  
...
```text
During the evening-shift interview the driver explains that road signs sometimes appear as two overlapping images after several hours, improving when either eye is covered, although this did not occur during the short consultation; he reports no diplopia at rest, and the nurse has not established the angle from central fixation or whether the symptom persists with the updated lenses.

A loose optometry slip lists right 6/12 and left 6/18 beside an earlier date and right 6/6 and left 6/9 beside a later date, but it does not identify which measurements were corrected; the driver describes a blurred patch off to one side, has no formal binocular field result, and has not supplied the specialist assessment.

```

Input SHA-256: `8f6eec81be6c0b6287045760f72f0c7dc78fcfdd0110a4130d83c46a616e9d8d`
Rule-result SHA-256: `65088ebedb60b86061fa212cb6cae88cc82a1b6539b8eb578e3df4160a2fa570`
Evidence-pack SHA-256: `472cba436cedaf1df790cc087a8ea207be4f4db92fe1abb3f19aa6a83ebc865d`
