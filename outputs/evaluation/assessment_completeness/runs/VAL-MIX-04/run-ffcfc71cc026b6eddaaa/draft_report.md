...
The provisional outcome reflects the applicable rule priority. Missing information in other modules remains visible and does not erase an established adverse finding.

- vision: `VIS-COM-DIPLOPIA-001` - Non-physiological diplopia within 20 degrees of central fixation does not meet either commercial unconditional or conditional standards.
- diabetes: `DM-COM-INSULIN-001` - Insulin-treated diabetes does not meet the commercial unconditional standard.

## Information coverage

- hypertension: No source-supported facts for this requested module; 0 supported fields; 2 unresolved rule fields.
- vision: Source-supported facts available; some facts require confirmation; 3 supported fields; 5 unresolved rule fields.
- hearing: No source-supported facts for this requested module; 0 supported fields; 3 unresolved rule fields.
- blackout: No source-supported facts for this requested module; 0 supported fields; 2 unresolved rule fields.
- diabetes: Source-supported facts available; 3 supported fields; 10 unresolved rule fields.
...
Confirm vision.visual_field.confirmed_defect (uncertainty): Independent source reading differs from the extraction. Although the ophthalmologist confirms non-physiological diplopia, it is not explicitly stated whether this is a visual field defect. The question specifically asks about a visual field defect, which is separate from diplopia, reduced visual acuity, and blur.
Fields withheld from rule inputs: vision.visual_field.confirmed_defect

### vision.visual_field.confirmed_defect — uncertainty

Independent source reading differs from the extraction. Although the ophthalmologist confirms non-physiological diplopia, it is not explicitly stated whether this is a visual field defect. The question specifically asks about a visual field defect, which is separate from diplopia, reduced visual acuity, and blur.
...
Rule-result SHA-256: `e7c951079e833c307969093ba5040dfa16e09072f938ee6ff0c6014e89637fc7`
Evidence-pack SHA-256: `a057717dcc0a3a6f45f3e9d0aef7251426ab86cb0505e1fbebcd5005885bccbb`
