# Clinical review draft — VAL-MIX-03

VAL-MIX-03: Insufficient information. 5 requested modules; 23 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
1 rules triggered from source-supported facts. The overall assessment is incomplete; this does not erase the findings below. Missing facts in any requested module can prevent an overall clearance.

- diabetes: `DM-COM-NONINSULIN-001` - Commercial drivers treated with a non-insulin glucose-lowering agent do not meet the unconditional standard.
...
- hearing: No source-supported facts for this requested module; some facts require confirmation; 0 supported fields; 3 unresolved rule fields.
- blackout: No source-supported facts for this requested module; 0 supported fields; 2 unresolved rule fields.
- diabetes: Source-supported facts available; 2 supported fields; 10 unresolved rule fields.
...
> The driver has confirmed type 2 diabetes, and the current GP medication reconciliation states that diabetes is treated with oral medication. The driver takes the prescribed tablets and explicitly denies current insulin use; an old appointment reminder about discussing injectable options is not a prescription and has not been treated as evidence that an injection was started. After a delayed lunch last month he felt shaky and ate a snack without assistance, but glucose was measured only after the symptoms settled, so the nurse has no verified measurement during that event and no treating-clinician classification of severe hypoglycaemia. He has brought four weeks of glucose entries rather than a complete three-month record, and the specialist review has not yet occurred. The nurse records the confirmed diabetes and current oral treatment separately from the unclassified episode and the unmeasured hearing complaint.
...
> His father used hearing aids, which does not establish the driver's threshold. The nurse records the confirmed diabetes and current oral treatment separately from the unclassified episode and the unmeasured hearing complaint.
...
Confirm hearing.audiometry.available (omission): Independent source reading differs from the extraction. The driver's note does not explicitly state that audiometry was not performed or no audiogram is available. Therefore, the audiogram is considered available.
...
Fields withheld from rule inputs: hearing.audiometry.available, hearing.clinical_assessment

### hearing.audiometry.available — omission

Independent source reading differs from the extraction. The driver's note does not explicitly state that audiometry was not performed or no audiogram is available. Therefore, the audiogram is considered available.

Source lines 7–7; characters 838:1214
> He also describes reduced radio clarity when the cab is noisy, although quiet conversation is easy and no complete audiogram accompanies the referral. His father used hearing aids, which does not establish the driver's threshold. The nurse records the confirmed diabetes and current oral treatment separately from the unclassified episode and the unmeasured hearing complaint.
...
- `hearing.audiometry.available` = UNKNOWN (requires_confirmation)
  - Source lines 7–7; chars 838:1214: He also describes reduced radio clarity when the cab is noisy, although quiet conversation is easy and no complete audiogram accompanies the referral. His father used hearing aids, which does not establish the driver's threshold. The nurse records the confirmed diabetes and current oral treatment separately from the unclassified episode and the unmeasured hearing complaint.
...
- `diabetes.present` = True (present)
  - Source lines 3–3; chars 56:197: The driver has confirmed type 2 diabetes, and the current GP medication reconciliation states that diabetes is treated with oral medication. 
  - Source lines 3–3; chars 56:197: The driver has confirmed type 2 diabetes, and the current GP medication reconciliation states that diabetes is treated with oral medication. 
  - Source lines 7–7; chars 1068:1215: The nurse records the confirmed diabetes and current oral treatment separately from the unclassified episode and the unmeasured hearing complaint. 
  - Source lines 3–3; chars 56:96: The driver has confirmed type 2 diabetes
...
After a delayed lunch last month he felt shaky and ate a snack without assistance, but glucose was measured only after the symptoms settled, so the nurse has no verified measurement during that event and no treating-clinician classification of severe hypoglycaemia. He has brought four weeks of glucose entries rather than a complete three-month record, and the specialist review has not yet occurred.

He also describes reduced radio clarity when the cab is noisy, although quiet conversation is easy and no complete audiogram accompanies the referral. His father used hearing aids, which does not establish the driver's threshold. The nurse records the confirmed diabetes and current oral treatment separately from the unclassified episode and the unmeasured hearing complaint.

```

Input SHA-256: `15c7f87d226f1ca3968ebcf6f81af902fe4cc9c75be891981fc358fac3e5ff28`
Rule-result SHA-256: `6d5b9abe9ddb3ae383708886ab79f7938fd382fadb92e695d5d4f4f9760a5bbe`
Evidence-pack SHA-256: `e746e1177a8871a417cddf2cb6923893d58b4108899a73654b21397e0a2f6b3e`
