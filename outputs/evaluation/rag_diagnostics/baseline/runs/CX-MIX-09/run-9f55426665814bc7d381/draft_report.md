...
Confirm vision.visual_field.binocular_horizontal_extent_degrees (omission): Independent source reading differs from the extraction. The driver's visual field was recorded as 135 degrees.
Confirm vision.monocular (omission): Independent source reading differs from the extraction. The driver's monocular status was explicitly stated.
Fields withheld from rule inputs: vision.monocular, vision.visual_field.binocular_horizontal_extent_degrees

### vision.visual_field.binocular_horizontal_extent_degrees — omission

Independent source reading differs from the extraction. The driver's visual field was recorded as 135 degrees.

Source lines 3–3; characters 359:426
> A field printout shows a binocular horizontal extent of 135 degrees

### vision.monocular — omission

Independent source reading differs from the extraction. The driver's monocular status was explicitly stated.

Source lines 5–5; characters 580:645
> He recalls being told that an old injury left one eye less useful
...
- `vision.specialist_assessment_available` = UNKNOWN (unknown)
- `vision.visual_field.binocular_horizontal_extent_degrees` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 359:426: A field printout shows a binocular horizontal extent of 135 degrees
- `vision.visual_field.confirmed_defect` = UNKNOWN (unknown)
...
- `vision.monocular` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 580:645: He recalls being told that an old injury left one eye less useful
...
Rule-result SHA-256: `0cb608d0054f5c1374f6eb33adafaffaa1554ff2da1bd5d2320f90b26d643ab3`
Evidence-pack SHA-256: `d65d93ac4fbc9e9b38288c41a55b81177af2790e039a22c3c251fbe9e101a841`
