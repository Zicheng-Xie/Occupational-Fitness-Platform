# Clinical review draft — SYN-M2-008

SYN-M2-008: Insufficient information. 5 requested modules; 13 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
| vision | Insufficient information | human_review | 7 |
...
- `vision.diplopia.present` = True (present)
  - Source lines 1–1; chars 124:153: Reports intermittent diplopia
  - Source lines 1–1; chars 124:153: Reports intermittent diplopia
...
- `hearing.clinical_assessment` = no_hearing_loss (present)
  - Source lines 1–1; chars 222:258: Hearing: normal without hearing aids
  - Source lines 1–1; chars 222:258: Hearing: normal without hearing aids
...
- [ ] Confirm missing/unverified case fact: vision.diplopia.physiological
- [ ] Confirm missing/unverified case fact: vision.diplopia.within_20_degrees
...
```text
Commercial driver assessment. 39-year-old female transport operator. BP 118/74 mmHg; pulse 72 bpm. Denies cardiac symptoms. Reports intermittent diplopia and a left visual field defect. No optometrist report is available. Hearing: normal without hearing aids.

```

Input SHA-256: `d42af50c940b2d44c742049211d42433468f0a68ec578c0bf2f1b2504f99511a`
Rule-result SHA-256: `fff0b395a6d71f5e24a68481dddfda8b59221014c31f39d7e68de542419b9025`
Evidence-pack SHA-256: `e73f8eba130d72440795db7f87861e6a38f89efd728febc59faecc9e48bd8ff1`

## Unverified local-model commentary

This commercial driver assessment presents insufficient information to determine fitness to hold an unconditional licence. The patient's hypertension is not well-controlled, and there is no optometrist report available to confirm the reported left visual field defect. The patient's hearing is normal without hearing aids. A thorough review of the patient's cardiovascular and neurological investigations is required to determine the mechanism of the reported blackouts and to assess fitness to drive.
