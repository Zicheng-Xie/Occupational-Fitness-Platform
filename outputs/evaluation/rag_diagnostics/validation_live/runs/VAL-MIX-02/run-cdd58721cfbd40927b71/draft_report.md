# Clinical review draft — VAL-MIX-02

VAL-MIX-02: Insufficient information. 5 requested modules; 16 unresolved fact fields. This draft is occupational fitness decision support. The result is limited to the implemented criteria and is not a licensing or employment decision.
...
| vision | Insufficient information | human_review | 5 |
...
> The driver experienced a witnessed blackout during a break four weeks earlier. The driver recalls being hot and hungry before the event, yet neither vasovagal syncope nor hypoglycaemia has been confirmed, and cardiac monitoring is still pending. He says there may have been an earlier episode of light-headedness without loss of awareness, which the nurse has not counted as a second blackout. Current visual measurements and the documented blackout are available, while the event mechanism, recurrence history and specialist advice remain incomplete.
...
> The driver recalls being hot and hungry before the event, yet neither vasovagal syncope nor hypoglycaemia has been confirmed, and cardiac monitoring is still pending.
...
> At today's examination, uncorrected visual acuity measures 6/12 in the right eye and 6/18 in the left eye, with each eye tested separately before glasses were applied. The optometrist's signed sheet confirms the measurements; the driver believes a newer pair of glasses improves road-sign reading, but no corrected measurement has yet been entered, and the nurse does not substitute that impression for a measured corrected acuity. Current visual measurements and the documented blackout are available, while the event mechanism, recurrence history and specialist advice remain incomplete.
...
Confirm blackout.mechanism_status (unsupported): Independent source reading differs from the extraction. The note does not explicitly state the mechanism status of the blackout, so the status is uncertain and the value is null.
Confirm vision.diplopia.present (uncertainty): Independent source reading differs from the extraction. The note does not explicitly state whether the driver experiences diplopia, so the status is uncertain and the value is null.
Confirm vision.specialist_assessment_available (omission): Independent source reading differs from the extraction. The note explicitly states that current visual measurements are available.
Confirm vision.visual_field.confirmed_defect (uncertainty): Independent source reading differs from the extraction. No confirmed visual field defect documented.
Fields withheld from rule inputs: blackout.mechanism_status, vision.diplopia.present, vision.specialist_assessment_available, vision.visual_field.confirmed_defect

### blackout.mechanism_status — unsupported

Independent source reading differs from the extraction. The note does not explicitly state the mechanism status of the blackout, so the status is uncertain and the value is null.

Source lines 5–5; characters 489:897
> The driver experienced a witnessed blackout during a break four weeks earlier. The witness describes complete loss of responsiveness followed by recovery, and the current referral explicitly states that the cause remains under investigation. The driver recalls being hot and hungry before the event, yet neither vasovagal syncope nor hypoglycaemia has been confirmed, and cardiac monitoring is still pending.

### vision.diplopia.present — uncertainty

Independent source reading differs from the extraction. The note does not explicitly state whether the driver experiences diplopia, so the status is uncertain and the value is null.

Source lines 3–3; characters 56:487
> At today's examination, uncorrected visual acuity measures 6/12 in the right eye and 6/18 in the left eye, with each eye tested separately before glasses were applied. The optometrist's signed sheet confirms the measurements; the driver believes a newer pair of glasses improves road-sign reading, but no corrected measurement has yet been entered, and the nurse does not substitute that impression for a measured corrected acuity.

### vision.specialist_assessment_available — omission

Independent source reading differs from the extraction. The note explicitly states that current visual measurements are available.
...
Independent source reading differs from the extraction. No confirmed visual field defect documented.
...
- `blackout.mechanism_status` = UNKNOWN (requires_confirmation)
  - Source lines 5–5; chars 568:731: The witness describes complete loss of responsiveness followed by recovery, and the current referral explicitly states that the cause remains under investigation. 
  - Source lines 5–5; chars 489:897: The driver experienced a witnessed blackout during a break four weeks earlier. The witness describes complete loss of responsiveness followed by recovery, and the current referral explicitly states that the cause remains under investigation. The driver recalls being hot and hungry before the event, yet neither vasovagal syncope nor hypoglycaemia has been confirmed, and cardiac monitoring is still pending.
- `blackout.occurred` = True (present)
  - Source lines 5–5; chars 489:568: The driver experienced a witnessed blackout during a break four weeks earlier. 
...
### VIS-COM-ACUITY-UNCONDITIONAL-001 — triggered

Uncorrected visual acuity does not meet the commercial unconditional standard.

- `vision.uncorrected.better_eye` = 6/12 (present)
  - Source lines 3–3; chars 56:224: At today's examination, uncorrected visual acuity measures 6/12 in the right eye and 6/18 in the left eye, with each eye tested separately before glasses were applied. 
  - Source lines 3–3; chars 56:224: At today's examination, uncorrected visual acuity measures 6/12 in the right eye and 6/18 in the left eye, with each eye tested separately before glasses were applied. 
- `vision.uncorrected.left.snellen` = 6/18 (present)
  - Source lines 3–3; chars 56:224: At today's examination, uncorrected visual acuity measures 6/12 in the right eye and 6/18 in the left eye, with each eye tested separately before glasses were applied. 
...
- `vision.specialist_assessment_available` = UNKNOWN (requires_confirmation)
  - Source lines 3–3; chars 56:487: At today's examination, uncorrected visual acuity measures 6/12 in the right eye and 6/18 in the left eye, with each eye tested separately before glasses were applied. The optometrist's signed sheet confirms the measurements; the driver believes a newer pair of glasses improves road-sign reading, but no corrected measurement has yet been entered, and the nurse does not substitute that impression for a measured corrected acuity.
...
- [ ] Confirm missing/unverified case fact: vision.corrected.better_eye
...
He says there may have been an earlier episode of light-headedness without loss of awareness, which the nurse has not counted as a second blackout. Current visual measurements and the documented blackout are available, while the event mechanism, recurrence history and specialist advice remain incomplete.

```

Input SHA-256: `f076b169a9cee75c4c9f9c3cdac5d459cc6e5089fd6589996d7f24a04044f3f8`
Rule-result SHA-256: `3dd43ed093dc670d087682ed546cf09ae73c69764ee42961069fc799481d4771`
Evidence-pack SHA-256: `2678563779c472437a00db38f371ad53cd2262fc455f127bcc4ff24312e779e3`
